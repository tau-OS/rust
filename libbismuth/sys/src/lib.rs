...
pub struct BisSwipeableInterface {
    ...
    pub get_snap_points: Option<unsafe extern "C" fn(*mut BisSwipeable, *mut c_int) -> *mut c_double>,
    ...
    pub get_swipe_area: Option<unsafe extern "C" fn(*mut BisSwipeable, BisNavigationDirection, gboolean, *mut gdk::GdkRectangle)>,
...
impl ::std::fmt::Debug for BisAlbum {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("BisAlbum @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for BisAlbumPage {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("BisAlbumPage @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for BisCarousel {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("BisCarousel @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for BisHugger {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("BisHugger @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for BisLapel {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("BisLapel @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for BisLatch {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("BisLatch @ {self:p}"))
         .finish()
    }
}
...
extern "C" {
    ...
    pub fn bis_spring_params_new(damping_ratio: c_double, mass: c_double, stiffness: c_double) -> *mut BisSpringParams;
    pub fn bis_spring_params_new_full(damping: c_double, mass: c_double, stiffness: c_double) -> *mut BisSpringParams;
    ...
    pub fn bis_album_get_adjacent_child(self_: *mut BisAlbum, direction: BisNavigationDirection) -> *mut gtk::GtkWidget;
    ...
    pub fn bis_album_get_child_by_name(self_: *mut BisAlbum, name: *const c_char) -> *mut gtk::GtkWidget;
    ...
    pub fn bis_album_get_page(self_: *mut BisAlbum, child: *mut gtk::GtkWidget) -> *mut BisAlbumPage;
    ...
    pub fn bis_album_insert_child_after(self_: *mut BisAlbum, child: *mut gtk::GtkWidget, sibling: *mut gtk::GtkWidget) -> *mut BisAlbumPage;
    pub fn bis_album_navigate(self_: *mut BisAlbum, direction: BisNavigationDirection) -> gboolean;
    pub fn bis_album_prepend(self_: *mut BisAlbum, child: *mut gtk::GtkWidget) -> *mut BisAlbumPage;
    pub fn bis_album_remove(self_: *mut BisAlbum, child: *mut gtk::GtkWidget);
    pub fn bis_album_reorder_child_after(self_: *mut BisAlbum, child: *mut gtk::GtkWidget, sibling: *mut gtk::GtkWidget);
    ...
    pub fn bis_album_set_child_transition_params(self_: *mut BisAlbum, params: *mut BisSpringParams);
    pub fn bis_album_set_fold_threshold_policy(self_: *mut BisAlbum, policy: BisFoldThresholdPolicy);
    ...
    pub fn bis_callback_animation_target_new(callback: BisAnimationTargetFunc, user_data: gpointer, destroy: glib::GDestroyNotify) -> *mut BisAnimationTarget;
    ...
    pub fn bis_carousel_insert(self_: *mut BisCarousel, child: *mut gtk::GtkWidget, position: c_int);
    ...
    pub fn bis_carousel_reorder(self_: *mut BisCarousel, child: *mut gtk::GtkWidget, position: c_int);
    pub fn bis_carousel_scroll_to(self_: *mut BisCarousel, widget: *mut gtk::GtkWidget, animate: gboolean);
    ...
    pub fn bis_carousel_set_allow_scroll_wheel(self_: *mut BisCarousel, allow_scroll_wheel: gboolean);
    ...
    pub fn bis_carousel_indicator_dots_get_carousel(self_: *mut BisCarouselIndicatorDots) -> *mut BisCarousel;
    pub fn bis_carousel_indicator_dots_set_carousel(self_: *mut BisCarouselIndicatorDots, carousel: *mut BisCarousel);
    ...
    pub fn bis_carousel_indicator_lines_get_carousel(self_: *mut BisCarouselIndicatorLines) -> *mut BisCarousel;
    pub fn bis_carousel_indicator_lines_set_carousel(self_: *mut BisCarouselIndicatorLines, carousel: *mut BisCarousel);
    ...
    pub fn bis_hugger_get_page(self_: *mut BisHugger, child: *mut gtk::GtkWidget) -> *mut BisHuggerPage;
    ...
    pub fn bis_hugger_set_switch_threshold_policy(self_: *mut BisHugger, policy: BisFoldThresholdPolicy);
    ...
    pub fn bis_lapel_set_fold_threshold_policy(self_: *mut BisLapel, policy: BisFoldThresholdPolicy);
    ...
    pub fn bis_lapel_set_transition_type(self_: *mut BisLapel, transition_type: BisLapelTransitionType);
    ...
    pub fn bis_latch_layout_set_tightening_threshold(self_: *mut BisLatchLayout, tightening_threshold: c_int);
    ...
    pub fn bis_latch_scrollable_set_child(self_: *mut BisLatchScrollable, child: *mut gtk::GtkWidget);
    pub fn bis_latch_scrollable_set_maximum_size(self_: *mut BisLatchScrollable, maximum_size: c_int);
    pub fn bis_latch_scrollable_set_tightening_threshold(self_: *mut BisLatchScrollable, tightening_threshold: c_int);
    ...
    #[cfg(feature = "v1_2")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_2")))]
    pub fn bis_property_animation_target_new(object: *mut gobject::GObject, property_name: *const c_char) -> *mut BisAnimationTarget;
    #[cfg(feature = "v1_2")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_2")))]
    pub fn bis_property_animation_target_new_for_pspec(object: *mut gobject::GObject, pspec: *mut gobject::GParamSpec) -> *mut BisAnimationTarget;
    #[cfg(feature = "v1_2")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_2")))]
    pub fn bis_property_animation_target_get_object(self_: *mut BisPropertyAnimationTarget) -> *mut gobject::GObject;
    #[cfg(feature = "v1_2")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v1_2")))]
    pub fn bis_property_animation_target_get_pspec(self_: *mut BisPropertyAnimationTarget) -> *mut gobject::GParamSpec;

    //=========================================================================
    // BisSpringAnimation
    //=========================================================================
    pub fn bis_spring_animation_get_type() -> GType;
    pub fn bis_spring_animation_new(widget: *mut gtk::GtkWidget, from: c_double, to: c_double, spring_params: *mut BisSpringParams, target: *mut BisAnimationTarget) -> *mut BisAnimation;
    ...
    pub fn bis_spring_animation_get_spring_params(self_: *mut BisSpringAnimation) -> *mut BisSpringParams;
    ...
    pub fn bis_spring_animation_set_initial_velocity(self_: *mut BisSpringAnimation, velocity: c_double);
    pub fn bis_spring_animation_set_latch(self_: *mut BisSpringAnimation, latch: gboolean);
    pub fn bis_spring_animation_set_spring_params(self_: *mut BisSpringAnimation, spring_params: *mut BisSpringParams);
    ...
    pub fn bis_swipe_tracker_set_allow_long_swipes(self_: *mut BisSwipeTracker, allow_long_swipes: gboolean);
    pub fn bis_swipe_tracker_set_allow_mouse_drag(self_: *mut BisSwipeTracker, allow_mouse_drag: gboolean);
    ...
    pub fn bis_timed_animation_new(widget: *mut gtk::GtkWidget, from: c_double, to: c_double, duration: c_uint, target: *mut BisAnimationTarget) -> *mut BisAnimation;
    ...
    pub fn bis_timed_animation_set_repeat_count(self_: *mut BisTimedAnimation, repeat_count: c_uint);
    ...
    pub fn bis_swipeable_get_snap_points(self_: *mut BisSwipeable, n_snap_points: *mut c_int) -> *mut c_double;
    pub fn bis_swipeable_get_swipe_area(self_: *mut BisSwipeable, navigation_direction: BisNavigationDirection, is_drag: gboolean, rect: *mut gdk::GdkRectangle);
