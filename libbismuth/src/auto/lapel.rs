...
impl LapelBuilder {
    ...
    pub fn lapel(self, lapel: &impl IsA<gtk::Widget>) -> Self {
        Self {
            builder: self.builder.property("lapel", lapel.clone().upcast()),
        }
    }

    pub fn lapel_position(self, lapel_position: gtk::PackType) -> Self {
        Self {
            builder: self.builder.property("lapel-position", lapel_position),
        }
    }
    ...
    pub fn reveal_lapel(self, reveal_lapel: bool) -> Self {
        Self {
            builder: self.builder.property("reveal-lapel", reveal_lapel),
        }
    }
