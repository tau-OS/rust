...
impl HuggerPage {
    ...
    pub fn child(&self) -> gtk::Widget {
        unsafe {
            from_glib_none(ffi::bis_hugger_page_get_child(self.to_glib_none().0))
        }
    }
    ...
    pub fn is_enabled(&self) -> bool {
        unsafe {
            from_glib(ffi::bis_hugger_page_get_enabled(self.to_glib_none().0))
        }
    }
    ...
    pub fn connect_enabled_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_enabled_trampoline<F: Fn(&HuggerPage) + 'static>(this: *mut ffi::BisHuggerPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
...
impl fmt::Display for HuggerPage {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str("HuggerPage")
    }
}
