...
use crate::{
    AlbumPage, AlbumTransitionType, FoldThresholdPolicy, NavigationDirection, SpringParams,
    Swipeable,
};
use glib::{
    prelude::*,
...
impl Album {
    ...
    pub fn new() -> Album {
        ...
        unsafe { gtk::Widget::from_glib_none(ffi::bis_album_new()).unsafe_cast() }
    }
    ...
    pub fn append(&self, child: &impl IsA<gtk::Widget>) -> AlbumPage {
        unsafe {
            from_glib_none(ffi::bis_album_append(
                self.to_glib_none().0,
    ...
    pub fn adjacent_child(&self, direction: NavigationDirection) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::bis_album_get_adjacent_child(
                self.to_glib_none().0,
                direction.into_glib(),
            ))
        }
    ...
    pub fn can_navigate_back(&self) -> bool {
        unsafe { from_glib(ffi::bis_album_get_can_navigate_back(self.to_glib_none().0)) }
    }
    ...
    pub fn can_navigate_forward(&self) -> bool {
        unsafe {
            from_glib(ffi::bis_album_get_can_navigate_forward(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    pub fn can_unfold(&self) -> bool {
        unsafe { from_glib(ffi::bis_album_get_can_unfold(self.to_glib_none().0)) }
    }
    ...
    pub fn child_by_name(&self, name: &str) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::bis_album_get_child_by_name(
                self.to_glib_none().0,
                name.to_glib_none().0,
            ))
        }
    ...
    pub fn child_transition_params(&self) -> SpringParams {
        unsafe {
            from_glib_full(ffi::bis_album_get_child_transition_params(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    pub fn is_child_transition_running(&self) -> bool {
        unsafe {
            from_glib(ffi::bis_album_get_child_transition_running(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    pub fn fold_threshold_policy(&self) -> FoldThresholdPolicy {
        unsafe {
            from_glib(ffi::bis_album_get_fold_threshold_policy(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    pub fn is_folded(&self) -> bool {
        unsafe { from_glib(ffi::bis_album_get_folded(self.to_glib_none().0)) }
    }

    #[doc(alias = "bis_album_get_homogeneous")]
    #[doc(alias = "get_homogeneous")]
    pub fn is_homogeneous(&self) -> bool {
        unsafe { from_glib(ffi::bis_album_get_homogeneous(self.to_glib_none().0)) }
    }
    ...
    pub fn mode_transition_duration(&self) -> u32 {
        unsafe { ffi::bis_album_get_mode_transition_duration(self.to_glib_none().0) }
    }
    ...
    pub fn page(&self, child: &impl IsA<gtk::Widget>) -> AlbumPage {
        unsafe {
            from_glib_none(ffi::bis_album_get_page(
                self.to_glib_none().0,
                child.as_ref().to_glib_none().0,
            ))
        }
    ...
    pub fn visible_child_name(&self) -> Option<glib::GString> {
        unsafe { from_glib_none(ffi::bis_album_get_visible_child_name(self.to_glib_none().0)) }
    }
    ...
    pub fn insert_child_after(
        ...
        unsafe {
            from_glib_none(ffi::bis_album_insert_child_after(
                self.to_glib_none().0,
                child.as_ref().to_glib_none().0,
    ...
    pub fn navigate(&self, direction: NavigationDirection) -> bool {
        unsafe {
            from_glib(ffi::bis_album_navigate(
                self.to_glib_none().0,
                direction.into_glib(),
            ))
        }
    ...
    pub fn prepend(&self, child: &impl IsA<gtk::Widget>) -> AlbumPage {
        unsafe {
            from_glib_none(ffi::bis_album_prepend(
                self.to_glib_none().0,
                child.as_ref().to_glib_none().0,
            ))
        }
    ...
    pub fn reorder_child_after(
        ...
        unsafe {
            ffi::bis_album_reorder_child_after(
                self.to_glib_none().0,
                child.as_ref().to_glib_none().0,
                sibling.map(|p| p.as_ref()).to_glib_none().0,
            );
    ...
    pub fn set_can_navigate_back(&self, can_navigate_back: bool) {
        unsafe {
            ffi::bis_album_set_can_navigate_back(
                self.to_glib_none().0,
    ...
    pub fn set_can_navigate_forward(&self, can_navigate_forward: bool) {
        unsafe {
            ffi::bis_album_set_can_navigate_forward(
                self.to_glib_none().0,
    ...
    pub fn set_child_transition_params(&self, params: &SpringParams) {
        unsafe {
            ffi::bis_album_set_child_transition_params(
                self.to_glib_none().0,
    ...
    pub fn set_visible_child(&self, visible_child: &impl IsA<gtk::Widget>) {
        unsafe {
            ffi::bis_album_set_visible_child(
                self.to_glib_none().0,
    ...
    pub fn connect_can_navigate_back_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_can_navigate_back_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
    ...
    pub fn connect_can_navigate_forward_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_can_navigate_forward_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_can_unfold_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_can_unfold_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_child_transition_params_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_child_transition_params_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_child_transition_running_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_child_transition_running_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_fold_threshold_policy_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_fold_threshold_policy_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_folded_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_folded_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_homogeneous_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_homogeneous_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_mode_transition_duration_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_mode_transition_duration_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_pages_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_pages_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_transition_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_transition_type_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_visible_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_visible_child_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_visible_child_name_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_visible_child_name_trampoline<F: Fn(&Album) + 'static>(
            this: *mut ffi::BisAlbum,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
