...
impl SpringParams {
    ...
    pub fn new(damping_ratio: f64, mass: f64, stiffness: f64) -> SpringParams {
        ...
        unsafe {
            from_glib_full(ffi::bis_spring_params_new(damping_ratio, mass, stiffness))
        }
    }
    ...
    pub fn new_full(damping: f64, mass: f64, stiffness: f64) -> SpringParams {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_full(ffi::bis_spring_params_new_full(damping, mass, stiffness))
        }
    }
    ...
    pub fn damping(&self) -> f64 {
        unsafe {
            ffi::bis_spring_params_get_damping(self.to_glib_none().0)
        }
    }
    ...
    pub fn damping_ratio(&self) -> f64 {
        unsafe {
            ffi::bis_spring_params_get_damping_ratio(self.to_glib_none().0)
        }
    }
    ...
    pub fn mass(&self) -> f64 {
        unsafe {
            ffi::bis_spring_params_get_mass(self.to_glib_none().0)
        }
    }
    ...
    pub fn stiffness(&self) -> f64 {
        unsafe {
            ffi::bis_spring_params_get_stiffness(self.to_glib_none().0)
        }
    }
}
