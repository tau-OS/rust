...
use crate::{FoldThresholdPolicy, HuggerPage, HuggerTransitionType};
use glib::{
    prelude::*,
...
pub struct HuggerBuilder {
    ...
    transition_type: Option<HuggerTransitionType>,
    xalign: Option<f32>,
    yalign: Option<f32>,
...
impl HuggerBuilder {
    ...
    pub fn build(self) -> Hugger {
        ...
        glib::Object::new::<Hugger>(&properties)
    }
    ...
    pub fn transition_type(mut self, transition_type: HuggerTransitionType) -> Self {
