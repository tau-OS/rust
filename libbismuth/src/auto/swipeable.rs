...
glib::wrapper! {
    ...
    pub struct Swipeable(Interface<ffi::BisSwipeable, ffi::BisSwipeableInterface>) @requires gtk::Widget, gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl<O: IsA<Swipeable>> SwipeableExt for O {
    ...
    fn swipe_area(
        ...
        unsafe {
            ...
            ffi::bis_swipeable_get_swipe_area(
                self.as_ref().to_glib_none().0,
