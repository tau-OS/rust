...
glib::wrapper! {
    ...
    pub struct CarouselIndicatorLines(Object<ffi::BisCarouselIndicatorLines, ffi::BisCarouselIndicatorLinesClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable;
