...
glib::wrapper! {
    ...
    pub struct CarouselIndicatorLines(Object<ffi::BisCarouselIndicatorLines, ffi::BisCarouselIndicatorLinesClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable;

    match fn {
        type_ => || ffi::bis_carousel_indicator_lines_get_type(),
    }
}

impl CarouselIndicatorLines {
    #[doc(alias = "bis_carousel_indicator_lines_new")]
    pub fn new() -> CarouselIndicatorLines {
        assert_initialized_main_thread!();
        unsafe {
            gtk::Widget::from_glib_none(ffi::bis_carousel_indicator_lines_new()).unsafe_cast()
        }
    }
    ...
    #[doc(alias = "bis_carousel_indicator_lines_get_carousel")]
    #[doc(alias = "get_carousel")]
    pub fn carousel(&self) -> Option<Carousel> {
        unsafe {
            from_glib_none(ffi::bis_carousel_indicator_lines_get_carousel(self.to_glib_none().0))
        }
    }

    #[doc(alias = "bis_carousel_indicator_lines_set_carousel")]
    #[doc(alias = "carousel")]
    pub fn set_carousel(&self, carousel: Option<&Carousel>) {
        unsafe {
            ffi::bis_carousel_indicator_lines_set_carousel(self.to_glib_none().0, carousel.to_glib_none().0);
        }
    }

    #[doc(alias = "carousel")]
    pub fn connect_carousel_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_carousel_trampoline<F: Fn(&CarouselIndicatorLines) + 'static>(this: *mut ffi::BisCarouselIndicatorLines, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
