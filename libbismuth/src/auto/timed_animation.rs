...
impl TimedAnimation {
    ...
    pub fn new(widget: &impl IsA<gtk::Widget>, from: f64, to: f64, duration: u32, target: impl IsA<AnimationTarget>) -> TimedAnimation {
        ...
        unsafe {
            Animation::from_glib_none(ffi::bis_timed_animation_new(widget.as_ref().to_glib_none().0, from, to, duration, target.upcast().into_glib_ptr())).unsafe_cast()
        }
    }
    ...
    pub fn is_alternate(&self) -> bool {
        unsafe {
            from_glib(ffi::bis_timed_animation_get_alternate(self.to_glib_none().0))
        }
    }
    ...
    pub fn duration(&self) -> u32 {
        unsafe {
            ffi::bis_timed_animation_get_duration(self.to_glib_none().0)
        }
    }
    ...
    pub fn easing(&self) -> Easing {
        unsafe {
            from_glib(ffi::bis_timed_animation_get_easing(self.to_glib_none().0))
        }
    }
    ...
    pub fn repeat_count(&self) -> u32 {
        unsafe {
            ffi::bis_timed_animation_get_repeat_count(self.to_glib_none().0)
        }
    }
    ...
    pub fn is_reverse(&self) -> bool {
        unsafe {
            from_glib(ffi::bis_timed_animation_get_reverse(self.to_glib_none().0))
        }
    }
    ...
    pub fn value_from(&self) -> f64 {
        unsafe {
            ffi::bis_timed_animation_get_value_from(self.to_glib_none().0)
        }
    }
    ...
    pub fn value_to(&self) -> f64 {
        unsafe {
            ffi::bis_timed_animation_get_value_to(self.to_glib_none().0)
        }
    }
    ...
    pub fn connect_alternate_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_alternate_trampoline<F: Fn(&TimedAnimation) + 'static>(this: *mut ffi::BisTimedAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::alternate\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_alternate_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "duration")]
    pub fn connect_duration_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_duration_trampoline<F: Fn(&TimedAnimation) + 'static>(this: *mut ffi::BisTimedAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
    ...
    pub fn connect_easing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_easing_trampoline<F: Fn(&TimedAnimation) + 'static>(this: *mut ffi::BisTimedAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::easing\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_easing_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "repeat-count")]
    pub fn connect_repeat_count_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_repeat_count_trampoline<F: Fn(&TimedAnimation) + 'static>(this: *mut ffi::BisTimedAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::repeat-count\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_repeat_count_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "reverse")]
    pub fn connect_reverse_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_reverse_trampoline<F: Fn(&TimedAnimation) + 'static>(this: *mut ffi::BisTimedAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::reverse\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_reverse_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "value-from")]
    pub fn connect_value_from_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_value_from_trampoline<F: Fn(&TimedAnimation) + 'static>(this: *mut ffi::BisTimedAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::value-from\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_value_from_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "value-to")]
    pub fn connect_value_to_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_value_to_trampoline<F: Fn(&TimedAnimation) + 'static>(this: *mut ffi::BisTimedAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::value-to\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_value_to_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
}
