...
glib::wrapper! {
    ...
    pub struct LatchScrollable(Object<ffi::BisLatchScrollable, ffi::BisLatchScrollableClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable, gtk::Scrollable;
    ...
    pub fn connect_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::child\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_child_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
...
pub struct LatchScrollableBuilder {
            builder: glib::object::ObjectBuilder<'static, LatchScrollable>,
        }
