...
glib::wrapper! {
    #[doc(alias = "BisLatch")]
    pub struct Latch(Object<ffi::BisLatch, ffi::BisLatchClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable;
...
impl Latch {
    ...
    pub fn new() -> Latch {
        ...
        unsafe {
            gtk::Widget::from_glib_none(ffi::bis_latch_new()).unsafe_cast()
        }
    }
    ...
    pub fn child(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::bis_latch_get_child(self.to_glib_none().0))
        }
    }
    ...
    pub fn maximum_size(&self) -> i32 {
        unsafe {
            ffi::bis_latch_get_maximum_size(self.to_glib_none().0)
        }
    }
    ...
    pub fn tightening_threshold(&self) -> i32 {
        unsafe {
            ffi::bis_latch_get_tightening_threshold(self.to_glib_none().0)
        }
    }
    ...
    pub fn set_child(&self, child: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::bis_latch_set_child(self.to_glib_none().0, child.map(|p| p.as_ref()).to_glib_none().0);
        }
    }
    ...
    pub fn connect_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_trampoline<F: Fn(&Latch) + 'static>(this: *mut ffi::BisLatch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    pub fn connect_maximum_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_maximum_size_trampoline<F: Fn(&Latch) + 'static>(this: *mut ffi::BisLatch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
    ...
    pub fn connect_tightening_threshold_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_tightening_threshold_trampoline<F: Fn(&Latch) + 'static>(this: *mut ffi::BisLatch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
