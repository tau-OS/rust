...
impl fmt::Display for AlbumTransitionType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "AlbumTransitionType::{}", match *self {
            Self::Over => "Over",
            Self::Under => "Under",
            Self::Slide => "Slide",
            _ => "Unknown",
...
impl fmt::Display for AnimationState {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "AnimationState::{}", match *self {
            Self::Idle => "Idle",
            Self::Paused => "Paused",
...
impl Easing {
    ...
    pub fn ease(self, value: f64) -> f64 {
        ...
        unsafe {
            ffi::bis_easing_ease(self.into_glib(), value)
        }
    }
}
...
impl fmt::Display for FoldThresholdPolicy {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "FoldThresholdPolicy::{}", match *self {
...
impl fmt::Display for HuggerTransitionType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "HuggerTransitionType::{}", match *self {
            Self::None => "None",
...
impl fmt::Display for LapelFoldPolicy {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "LapelFoldPolicy::{}", match *self {
            Self::Never => "Never",
            Self::Always => "Always",
            Self::Auto => "Auto",
            _ => "Unknown",
...
impl fmt::Display for LapelTransitionType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "LapelTransitionType::{}", match *self {
            Self::Over => "Over",
            Self::Under => "Under",
            Self::Slide => "Slide",
            _ => "Unknown",
...
impl fmt::Display for NavigationDirection {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "NavigationDirection::{}", match *self {
            Self::Back => "Back",
