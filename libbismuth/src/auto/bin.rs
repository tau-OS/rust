...
glib::wrapper! {
    #[doc(alias = "BisBin")]
    pub struct Bin(Object<ffi::BisBin, ffi::BisBinClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::bis_bin_get_type(),
    }
}
...
impl Bin {
    ...
    #[doc(alias = "bis_bin_new")]
    pub fn new() -> Bin {
        assert_initialized_main_thread!();
        unsafe {
            gtk::Widget::from_glib_none(ffi::bis_bin_new()).unsafe_cast()
        }
    }
...
pub trait BinExt: IsA<Bin> + sealed::Sealed + 'static {
    #[doc(alias = "bis_bin_get_child")]
    #[doc(alias = "get_child")]
    fn child(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::bis_bin_get_child(self.as_ref().to_glib_none().0))
        }
    }

    #[doc(alias = "bis_bin_set_child")]
    #[doc(alias = "child")]
    fn set_child(&self, child: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::bis_bin_set_child(self.as_ref().to_glib_none().0, child.map(|p| p.as_ref()).to_glib_none().0);
        }
    }

    #[doc(alias = "child")]
    fn connect_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_trampoline<P: IsA<Bin>, F: Fn(&P) + 'static>(this: *mut ffi::BisBin, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::child\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_child_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
