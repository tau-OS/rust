...
glib::wrapper! {
    ...
    pub struct Carousel(Object<ffi::BisCarousel, ffi::BisCarouselClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, Swipeable, gtk::Orientable;
    ...
    pub fn connect_page_changed<F: Fn(&Self, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"page-changed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(page_changed_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_allow_scroll_wheel_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::allow-scroll-wheel\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_allow_scroll_wheel_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_interactive_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::interactive\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_interactive_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_n_pages_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::n-pages\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_n_pages_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_position_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::position\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_position_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_reveal_duration_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::reveal-duration\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_reveal_duration_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_scroll_params_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::scroll-params\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_scroll_params_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::spacing\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_spacing_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
}
...
pub struct CarouselBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("allow-scroll-wheel", allow_scroll_wheel), }
                        }

                            pub fn interactive(self, interactive: bool) -> Self {
                            Self { builder: self.builder.property("interactive", interactive), }
                        }

                            pub fn reveal_duration(self, reveal_duration: u32) -> Self {
                            Self { builder: self.builder.property("reveal-duration", reveal_duration), }
                        }

                            pub fn scroll_params(self, scroll_params: &SpringParams) -> Self {
                            Self { builder: self.builder.property("scroll-params", scroll_params.clone()), }
                        }
