...
glib::wrapper! {
    #[doc(alias = "BisCarouselIndicatorDots")]
    pub struct CarouselIndicatorDots(Object<ffi::BisCarouselIndicatorDots, ffi::BisCarouselIndicatorDotsClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable;

    match fn {
        type_ => || ffi::bis_carousel_indicator_dots_get_type(),
    }
}

impl CarouselIndicatorDots {
    #[doc(alias = "bis_carousel_indicator_dots_new")]
    pub fn new() -> CarouselIndicatorDots {
        assert_initialized_main_thread!();
        unsafe {
            gtk::Widget::from_glib_none(ffi::bis_carousel_indicator_dots_new()).unsafe_cast()
        }
    }
    ...
    #[doc(alias = "bis_carousel_indicator_dots_get_carousel")]
    #[doc(alias = "get_carousel")]
    pub fn carousel(&self) -> Option<Carousel> {
        unsafe {
            from_glib_none(ffi::bis_carousel_indicator_dots_get_carousel(self.to_glib_none().0))
        }
    }

    #[doc(alias = "bis_carousel_indicator_dots_set_carousel")]
    #[doc(alias = "carousel")]
    pub fn set_carousel(&self, carousel: Option<&Carousel>) {
        unsafe {
            ffi::bis_carousel_indicator_dots_set_carousel(self.to_glib_none().0, carousel.to_glib_none().0);
        }
    }

    #[doc(alias = "carousel")]
    pub fn connect_carousel_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_carousel_trampoline<F: Fn(&CarouselIndicatorDots) + 'static>(this: *mut ffi::BisCarouselIndicatorDots, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::carousel\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_carousel_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
}
...
pub struct CarouselIndicatorDotsBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("carousel", carousel.clone()), }
                        }
