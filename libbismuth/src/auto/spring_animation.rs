...
impl SpringAnimation {
    ...
    pub fn new(
        ...
        unsafe {
            Animation::from_glib_none(ffi::bis_spring_animation_new(
    ...
    pub fn spring_params(&self) -> SpringParams {
        unsafe {
            from_glib_none(ffi::bis_spring_animation_get_spring_params(
                self.to_glib_none().0,
            ))
        }
    }
    ...
    pub fn value_from(&self) -> f64 {
        unsafe { ffi::bis_spring_animation_get_value_from(self.to_glib_none().0) }
    }

    #[doc(alias = "bis_spring_animation_get_value_to")]
    #[doc(alias = "get_value_to")]
    pub fn value_to(&self) -> f64 {
        unsafe { ffi::bis_spring_animation_get_value_to(self.to_glib_none().0) }
    }

    #[doc(alias = "bis_spring_animation_get_velocity")]
    #[doc(alias = "get_velocity")]
    pub fn velocity(&self) -> f64 {
        unsafe { ffi::bis_spring_animation_get_velocity(self.to_glib_none().0) }
    }
    ...
    pub fn set_spring_params(&self, spring_params: &SpringParams) {
        unsafe {
            ffi::bis_spring_animation_set_spring_params(
                self.to_glib_none().0,
    ...
    pub fn connect_epsilon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_epsilon_trampoline<F: Fn(&SpringAnimation) + 'static>(
            this: *mut ffi::BisSpringAnimation,
    ...
    pub fn connect_latch_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_latch_trampoline<F: Fn(&SpringAnimation) + 'static>(
            this: *mut ffi::BisSpringAnimation,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
