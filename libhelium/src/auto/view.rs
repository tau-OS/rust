...
pub trait ViewExt: IsA<View> + sealed::Sealed + 'static {
    ...
    fn add_child(&self, builder: &gtk::Builder, child: &impl IsA<glib::Object>, type_: Option<&str>) {
        unsafe {
            ffi::he_view_add_child(self.as_ref().to_glib_none().0, builder.to_glib_none().0, child.as_ref().to_glib_none().0, type_.to_glib_none().0);
        }
    }
    ...
    fn add(&self, widget: &impl IsA<gtk::Widget>) {
        unsafe {
            ffi::he_view_add(self.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0);
        }
    }
    ...
    fn title(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_view_get_title(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn stack(&self) -> gtk::Stack {
        unsafe {
            from_glib_none(ffi::he_view_get_stack(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn subtitle(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_view_get_subtitle(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<View>, F: Fn(&P) + 'static>(this: *mut ffi::HeView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_stack_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stack_trampoline<P: IsA<View>, F: Fn(&P) + 'static>(this: *mut ffi::HeView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(View::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_subtitle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_subtitle_trampoline<P: IsA<View>, F: Fn(&P) + 'static>(this: *mut ffi::HeView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(View::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
