...
impl SegmentedButton {
    ...
    pub fn new() -> SegmentedButton {
        ...
        unsafe {
            from_glib_none(ffi::he_segmented_button_new())
        }
    }
...
pub struct SegmentedButtonBuilder {
    ...
    pub fn baseline_child(self, baseline_child: i32) -> Self {
                            Self { builder: self.builder.property("baseline-child", baseline_child), }
                        }
...
pub trait SegmentedButtonExt: IsA<SegmentedButton> + sealed::Sealed + 'static {
    ...
    fn add_child(&self, builder: &gtk::Builder, child: &impl IsA<glib::Object>, type_: Option<&str>) {
        unsafe {
            ffi::he_segmented_button_add_child(self.as_ref().to_glib_none().0, builder.to_glib_none().0, child.as_ref().to_glib_none().0, type_.to_glib_none().0);
        }
    }
}
