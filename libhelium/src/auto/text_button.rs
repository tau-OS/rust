...
glib::wrapper! {
    #[doc(alias = "HeTextButton")]
    pub struct TextButton(Object<ffi::HeTextButton, ffi::HeTextButtonClass>) @extends Button, gtk::Button, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;

    match fn {
        type_ => || ffi::he_text_button_get_type(),
    }
}
...
impl TextButton {
    ...
    #[doc(alias = "he_text_button_new")]
    pub fn new(label: &str) -> TextButton {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_text_button_new(label.to_glib_none().0))
        }
    }

    #[doc(alias = "he_text_button_new_from_icon")]
    pub fn from_icon(icon: &str) -> TextButton {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_text_button_new_from_icon(icon.to_glib_none().0))
        }
    }
            ...
            ///
            /// This method returns an instance of [`TextButtonBuilder`](crate::builders::TextButtonBuilder) which can be used to create [`TextButton`] objects.
            pub fn builder() -> TextButtonBuilder {
                TextButtonBuilder::new()
            }
...
// rustdoc-stripper-ignore-next
        /// A [builder-pattern] type to construct [`TextButton`] objects.
        ///
        /// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct TextButtonBuilder {
            builder: glib::object::ObjectBuilder<'static, TextButton>,
        }
