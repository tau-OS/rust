...
glib::wrapper! {
    ...
    pub struct TextButton(Object<ffi::HeTextButton, ffi::HeTextButtonClass>) @extends Button, gtk::Button, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
...
impl TextButtonBuilder {
    // rustdoc-stripper-ignore-next
    /// Create a new [`TextButtonBuilder`].
    pub fn new() -> Self {
        Self::default()
    }
...
if let Some(ref action_name) = self.action_name {
        ...
        glib::Object::new::<TextButton>(&properties)
...
impl fmt::Display for TextButton {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str("TextButton")
    }
}
