...
impl DatePicker {
    ...
    pub fn with_format(format: &str) -> DatePicker {
        ...
        unsafe {
            from_glib_none(ffi::he_date_picker_new_with_format(format.to_glib_none().0))
        }
    }
    ...
    pub fn new() -> DatePicker {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_date_picker_new())
        }
    }
...
pub trait DatePickerExt: IsA<DatePicker> + sealed::Sealed + 'static {
    ...
    fn format(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_date_picker_get_format(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn date(&self) -> glib::DateTime {
        unsafe {
            from_glib_none(ffi::he_date_picker_get_date(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_date_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_date_trampoline<P: IsA<DatePicker>, F: Fn(&P) + 'static>(this: *mut ffi::HeDatePicker, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::date\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_date_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
