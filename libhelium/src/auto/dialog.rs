...
use crate::{FillButton,TintButton,Window};
use glib::{prelude::*,signal::{connect_raw, SignalHandlerId},translate::*};
use std::{boxed::Box as Box_,fmt,mem::transmute};

glib::wrapper! {
    #[doc(alias = "HeDialog")]
    pub struct Dialog(Object<ffi::HeDialog, ffi::HeDialogClass>) @extends Window, gtk::Window, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Native, gtk::Root, gtk::ShortcutManager;
...
pub struct DialogBuilder {
    ...
    info: Option<String>,
    icon: Option<String>,
    secondary_button: Option<TintButton>,
    primary_button: Option<FillButton>,
...
if let Some(ref width_request) = self.width_request {
    ...
    pub fn secondary_button(mut self, secondary_button: &impl IsA<TintButton>) -> Self {
        self.secondary_button = Some(secondary_button.clone().upcast());
        self
    }

    pub fn primary_button(mut self, primary_button: &impl IsA<FillButton>) -> Self {
...
impl<O: IsA<Dialog>> DialogExt for O {
    ...
    fn subtitle(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_dialog_get_subtitle(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_subtitle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_subtitle_trampoline<P: IsA<Dialog>, F: Fn(&P) + 'static>(this: *mut ffi::HeDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
