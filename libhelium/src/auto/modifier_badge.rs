...
glib::wrapper! {
    ...
    pub struct ModifierBadge(Object<ffi::HeModifierBadge, ffi::HeModifierBadgeClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl ModifierBadge {
    ...
    pub fn new(label: Option<&str>) -> ModifierBadge {
        ...
        unsafe {
            from_glib_none(ffi::he_modifier_badge_new(label.to_glib_none().0))
        }
    }
...
pub struct ModifierBadgeBuilder {
    ...
    tinted: Option<bool>,
    label: Option<String>,
    alignment: Option<ModifierBadgeAlignment>,
...
impl ModifierBadgeBuilder {
    // rustdoc-stripper-ignore-next
    /// Create a new [`ModifierBadgeBuilder`].
    pub fn new() -> Self {
        Self::default()
    }
...
if let Some(ref tinted) = self.tinted {
                properties.push(("tinted", tinted));
            }
...
if let Some(ref width_request) = self.width_request {
        ...
        glib::Object::new::<ModifierBadge>(&properties)
    ...
    pub fn alignment(mut self, alignment: ModifierBadgeAlignment) -> Self {
...
impl<O: IsA<ModifierBadge>> ModifierBadgeExt for O {
    fn color(&self) -> Colors {
        unsafe {
            from_glib(ffi::he_modifier_badge_get_color(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn is_tinted(&self) -> bool {
        unsafe {
            from_glib(ffi::he_modifier_badge_get_tinted(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn label(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::he_modifier_badge_get_label(self.as_ref().to_glib_none().0))
        }
    }

    fn set_label(&self, value: Option<&str>) {
        unsafe {
            ffi::he_modifier_badge_set_label(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn alignment(&self) -> ModifierBadgeAlignment {
        unsafe {
            from_glib(ffi::he_modifier_badge_get_alignment(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_color_trampoline<P: IsA<ModifierBadge>, F: Fn(&P) + 'static>(this: *mut ffi::HeModifierBadge, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_tinted_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_tinted_trampoline<P: IsA<ModifierBadge>, F: Fn(&P) + 'static>(this: *mut ffi::HeModifierBadge, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ModifierBadge::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::tinted\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_tinted_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_label_trampoline<P: IsA<ModifierBadge>, F: Fn(&P) + 'static>(this: *mut ffi::HeModifierBadge, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ModifierBadge::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_alignment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_alignment_trampoline<P: IsA<ModifierBadge>, F: Fn(&P) + 'static>(this: *mut ffi::HeModifierBadge, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ModifierBadge::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
