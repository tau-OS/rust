...
use crate::{ffi,Bin,Colors,ModifierBadgeAlignment};
...
pub struct ModifierBadgeBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("tinted", tinted), }
                        }
    ...
    fn connect_tinted_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::tinted\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_tinted_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
