...
use crate::{ffi,Bin,ContentBlockImage,ContentBlockImageClusterImagePosition};
...
pub trait ContentBlockImageClusterExt: IsA<ContentBlockImageCluster> + sealed::Sealed + 'static {
