...
impl<O: IsA<Application>> HeApplicationExt for O {
    ...
    fn set_default_accent_color(&self, value: Option<&mut ColorRGBColor>) {
        unsafe {
            ffi::he_application_set_default_accent_color(self.as_ref().to_glib_none().0, value.to_glib_none_mut().0);
        }
    }
    ...
    fn accent_color(&self) -> ColorRGBColor {
        unsafe {
            ...
            ffi::he_application_get_accent_color(self.as_ref().to_glib_none().0, result.to_glib_none_mut().0);
            result
        }
    }
    ...
    fn foreground(&self) -> ColorRGBColor {
        unsafe {
            let mut result = ColorRGBColor::uninitialized();
            ffi::he_application_get_foreground(self.as_ref().to_glib_none().0, result.to_glib_none_mut().0);
            result
        }
    }
    ...
    fn accent_foreground(&self) -> ColorRGBColor {
        unsafe {
            let mut result = ColorRGBColor::uninitialized();
            ffi::he_application_get_accent_foreground(self.as_ref().to_glib_none().0, result.to_glib_none_mut().0);
            result
        }
    }
