...
pub struct ApplicationBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("default-accent-color", default_accent_color), }
                        }

                            pub fn override_accent_color(self, override_accent_color: bool) -> Self {
                            Self { builder: self.builder.property("override-accent-color", override_accent_color), }
                        }

                            pub fn override_dark_style(self, override_dark_style: bool) -> Self {
                            Self { builder: self.builder.property("override-dark-style", override_dark_style), }
                        }

                            pub fn override_contrast(self, override_contrast: bool) -> Self {
                            Self { builder: self.builder.property("override-contrast", override_contrast), }
                        }

                            pub fn default_contrast(self, default_contrast: f64) -> Self {
                            Self { builder: self.builder.property("default-contrast", default_contrast), }
                        }
...
pub trait HeApplicationExt: IsA<Application> + sealed::Sealed + 'static {
    ...
    fn is_override_accent_color(&self) -> bool {
        unsafe {
            from_glib(ffi::he_application_get_override_accent_color(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_override_accent_color(&self, value: bool) {
        unsafe {
            ffi::he_application_set_override_accent_color(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }
    ...
    fn is_override_dark_style(&self) -> bool {
        unsafe {
            from_glib(ffi::he_application_get_override_dark_style(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_override_dark_style(&self, value: bool) {
        unsafe {
            ffi::he_application_set_override_dark_style(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }
    ...
    fn is_override_contrast(&self) -> bool {
        unsafe {
            from_glib(ffi::he_application_get_override_contrast(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_override_contrast(&self, value: bool) {
        unsafe {
            ffi::he_application_set_override_contrast(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }
    ...
    fn default_contrast(&self) -> f64 {
        unsafe {
            ffi::he_application_get_default_contrast(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn connect_default_accent_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::default-accent-color\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_default_accent_color_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "override-accent-color")]
    fn connect_override_accent_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_override_accent_color_trampoline<P: IsA<Application>, F: Fn(&P) + 'static>(this: *mut ffi::HeApplication, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Application::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::override-accent-color\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_override_accent_color_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "override-dark-style")]
    fn connect_override_dark_style_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_override_dark_style_trampoline<P: IsA<Application>, F: Fn(&P) + 'static>(this: *mut ffi::HeApplication, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Application::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::override-dark-style\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_override_dark_style_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "override-contrast")]
    fn connect_override_contrast_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_override_contrast_trampoline<P: IsA<Application>, F: Fn(&P) + 'static>(this: *mut ffi::HeApplication, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Application::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::override-contrast\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_override_contrast_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "default-contrast")]
    fn connect_default_contrast_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_default_contrast_trampoline<P: IsA<Application>, F: Fn(&P) + 'static>(this: *mut ffi::HeApplication, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Application::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::default-contrast\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_default_contrast_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
