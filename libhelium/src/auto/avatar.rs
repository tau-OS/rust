...
pub trait AvatarExt: IsA<Avatar> + sealed::Sealed + 'static {
    ...
    fn size(&self) -> i32 {
        unsafe {
            ffi::he_avatar_get_size(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn text(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::he_avatar_get_text(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn is_status(&self) -> bool {
        unsafe {
            from_glib(ffi::he_avatar_get_status(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn image(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::he_avatar_get_image(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_size_trampoline<P: IsA<Avatar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAvatar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_text_trampoline<P: IsA<Avatar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAvatar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Avatar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_status_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_status_trampoline<P: IsA<Avatar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAvatar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Avatar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_image_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_image_trampoline<P: IsA<Avatar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAvatar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Avatar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
