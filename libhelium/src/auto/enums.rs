...
impl fmt::Display for AboutWindowLicenses {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "AboutWindowLicenses::{}", match *self {
            Self::Gplv3 => "Gplv3",
            Self::Mit => "Mit",
            Self::Mplv2 => "Mplv2",
...
impl fmt::Display for BannerStyle {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "BannerStyle::{}", match *self {
            Self::Info => "Info",
...
impl fmt::Display for BottomBarPosition {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "BottomBarPosition::{}", match *self {
            Self::Left => "Left",
            Self::Right => "Right",
            _ => "Unknown",
        })
...
impl fmt::Display for ContentBlockImageClusterImagePosition {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "ContentBlockImageClusterImagePosition::{}", match *self {
...
impl fmt::Display for DesktopColorScheme {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "DesktopColorScheme::{}", match *self {
...
impl fmt::Display for ModifierBadgeAlignment {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "ModifierBadgeAlignment::{}", match *self {
            Self::Left => "Left",
            Self::Center => "Center",
            Self::Right => "Right",
            _ => "Unknown",
...
impl fmt::Display for OverlayButtonAlignment {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "OverlayButtonAlignment::{}", match *self {
            Self::Left => "Left",
            Self::Center => "Center",
            Self::Right => "Right",
            _ => "Unknown",
...
impl fmt::Display for OverlayButtonSize {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "OverlayButtonSize::{}", match *self {
            Self::Small => "Small",
            Self::Medium => "Medium",
            Self::Large => "Large",
            _ => "Unknown",
