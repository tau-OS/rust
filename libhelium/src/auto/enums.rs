...
#[derive(Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Clone, Copy)]
#[non_exhaustive]
#[doc(alias = "HeAvatarStatusColor")]
pub enum AvatarStatusColor {
    #[doc(alias = "HE_AVATAR_STATUS_COLOR_RED")]
    Red,
    #[doc(alias = "HE_AVATAR_STATUS_COLOR_GREEN")]
    Green,
    #[doc(alias = "HE_AVATAR_STATUS_COLOR_YELLOW")]
    Yellow,
    #[doc(hidden)]
    __Unknown(i32),
}
...
#[doc(hidden)]
impl IntoGlib for AvatarStatusColor {
    type GlibType = ffi::HeAvatarStatusColor;

    #[inline]
    fn into_glib(self) -> ffi::HeAvatarStatusColor {
        match self {
            Self::Red => ffi::HE_AVATAR_STATUS_COLOR_RED,
            Self::Green => ffi::HE_AVATAR_STATUS_COLOR_GREEN,
            Self::Yellow => ffi::HE_AVATAR_STATUS_COLOR_YELLOW,
            Self::__Unknown(value) => value,
        }
    }
}
...
#[doc(hidden)]
impl FromGlib<ffi::HeAvatarStatusColor> for AvatarStatusColor {
    #[inline]
    unsafe fn from_glib(value: ffi::HeAvatarStatusColor) -> Self {
        skip_assert_initialized!();

        match value {
            ffi::HE_AVATAR_STATUS_COLOR_RED => Self::Red,
            ffi::HE_AVATAR_STATUS_COLOR_GREEN => Self::Green,
            ffi::HE_AVATAR_STATUS_COLOR_YELLOW => Self::Yellow,
            value => Self::__Unknown(value),
        }
    }
}

impl StaticType for AvatarStatusColor {
    #[inline]
    #[doc(alias = "he_avatar_status_color_get_type")]
    fn static_type() -> glib::Type {
        unsafe { from_glib(ffi::he_avatar_status_color_get_type()) }
    }
}

impl glib::HasParamSpec for AvatarStatusColor {
    type ParamSpec = glib::ParamSpecEnum;
    type SetValue = Self;
    type BuilderFn = fn(&str, Self) -> glib::ParamSpecEnumBuilder<Self>;
...
impl glib::value::ValueType for AvatarStatusColor {
    type Type = Self;
}

unsafe impl<'a> glib::value::FromValue<'a> for AvatarStatusColor {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
impl ToValue for AvatarStatusColor {
    #[inline]
    fn to_value(&self) -> glib::Value {
        let mut value = glib::Value::for_value_type::<Self>();
        unsafe {
...
impl From<AvatarStatusColor> for glib::Value {
    #[inline]
    fn from(v: AvatarStatusColor) -> Self {
        skip_assert_initialized!();
        ToValue::to_value(&v)
    }
}
