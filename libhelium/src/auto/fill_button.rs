...
glib::wrapper! {
    ...
    pub struct FillButton(Object<ffi::HeFillButton, ffi::HeFillButtonClass>) @extends Button, gtk::Button, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
...
impl FillButton {
    ...
    pub fn new(label: &str) -> FillButton {
        ...
        unsafe {
            from_glib_none(ffi::he_fill_button_new(label.to_glib_none().0))
        }
    }
