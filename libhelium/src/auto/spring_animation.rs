...
impl SpringAnimation {
    ...
    pub fn new(widget: &impl IsA<gtk::Widget>, from: f64, to: f64, sparams: impl IsA<SpringParams>, target: impl IsA<AnimationTarget>) -> SpringAnimation {
        skip_assert_initialized!();
        unsafe {
            from_glib_full(ffi::he_spring_animation_new(widget.as_ref().to_glib_none().0, from, to, sparams.upcast().into_glib_ptr(), target.upcast().into_glib_ptr()))
        }
    }
...
pub struct SpringAnimationBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("estimated-duration", estimated_duration), }
                        }
                            ...
                            Self { builder: self.builder.property("spring-params", spring_params.clone().upcast()), }
                        }
                            ...
                            Self { builder: self.builder.property("velocity", velocity), }
                        }
...
pub trait SpringAnimationExt: IsA<SpringAnimation> + sealed::Sealed + 'static {
    ...
    fn epsilon(&self) -> f64 {
        unsafe {
            ffi::he_spring_animation_get_epsilon(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn estimated_duration(&self) -> u32 {
        unsafe {
            ffi::he_spring_animation_get_estimated_duration(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn initial_velocity(&self) -> f64 {
        unsafe {
            ffi::he_spring_animation_get_initial_velocity(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn is_latch(&self) -> bool {
        unsafe {
            from_glib(ffi::he_spring_animation_get_latch(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn spring_params(&self) -> SpringParams {
        unsafe {
            from_glib_none(ffi::he_spring_animation_get_spring_params(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_spring_params(&self, value: &impl IsA<SpringParams>) {
        unsafe {
            ffi::he_spring_animation_set_spring_params(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }
    ...
    fn value_from(&self) -> f64 {
        unsafe {
            ffi::he_spring_animation_get_value_from(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn value_to(&self) -> f64 {
        unsafe {
            ffi::he_spring_animation_get_value_to(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn velocity(&self) -> f64 {
        unsafe {
            ffi::he_spring_animation_get_velocity(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn connect_epsilon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_epsilon_trampoline<P: IsA<SpringAnimation>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::epsilon\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_epsilon_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "estimated-duration")]
    fn connect_estimated_duration_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_estimated_duration_trampoline<P: IsA<SpringAnimation>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpringAnimation::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::estimated-duration\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_estimated_duration_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "initial-velocity")]
    fn connect_initial_velocity_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_initial_velocity_trampoline<P: IsA<SpringAnimation>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpringAnimation::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::initial-velocity\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_initial_velocity_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "latch")]
    fn connect_latch_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_latch_trampoline<P: IsA<SpringAnimation>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpringAnimation::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::latch\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_latch_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "spring-params")]
    fn connect_spring_params_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_spring_params_trampoline<P: IsA<SpringAnimation>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpringAnimation::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::spring-params\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_spring_params_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "value-from")]
    fn connect_value_from_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_value_from_trampoline<P: IsA<SpringAnimation>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpringAnimation::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_value_to_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_value_to_trampoline<P: IsA<SpringAnimation>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpringAnimation::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_velocity_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_velocity_trampoline<P: IsA<SpringAnimation>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringAnimation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpringAnimation::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::velocity\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_velocity_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
