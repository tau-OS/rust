...
glib::wrapper! {
    ...
    pub struct WelcomeScreen(Object<ffi::HeWelcomeScreen, ffi::HeWelcomeScreenClass>) @extends Bin, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
pub struct WelcomeScreenBuilder {
            builder: glib::object::ObjectBuilder<'static, WelcomeScreen>,
        }
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            pub fn appname(self, appname: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("appname", appname.into()), }
                        }
    ...
    fn connect_appname_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::appname\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_appname_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
