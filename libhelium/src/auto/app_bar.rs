...
glib::wrapper! {
    #[doc(alias = "HeAppBar")]
    pub struct AppBar(Object<ffi::HeAppBar, ffi::HeAppBarClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl<O: IsA<AppBar>> AppBarExt for O {
    ...
    fn is_flat(&self) -> bool {
        unsafe {
            from_glib(ffi::he_app_bar_get_flat(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn shows_buttons(&self) -> bool {
        unsafe {
            from_glib(ffi::he_app_bar_get_show_buttons(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_stack_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::stack\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_stack_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_scroller_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::scroller\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_scroller_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_viewtitle_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::viewtitle-label\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_viewtitle_label_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_flat_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_flat_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::flat\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_flat_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_show_buttons_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_buttons_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::show-buttons\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_show_buttons_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_show_back_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-back\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_show_back_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
