...
impl AppBar {
    ...
    pub fn new() -> AppBar {
        ...
        unsafe {
            from_glib_none(ffi::he_app_bar_new())
        }
    }
...
pub struct AppBarBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("scroller", scroller.clone()), }
                        }

                            pub fn is_compact(self, is_compact: bool) -> Self {
                            Self { builder: self.builder.property("is-compact", is_compact), }
                        }

                            pub fn viewtitle_label(self, viewtitle_label: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("viewtitle-label", viewtitle_label.into()), }
                        }

                            pub fn viewtitle_widget(self, viewtitle_widget: &impl IsA<gtk::Widget>) -> Self {
                            Self { builder: self.builder.property("viewtitle-widget", viewtitle_widget.clone().upcast()), }
                        }

                            pub fn viewsubtitle_label(self, viewsubtitle_label: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("viewsubtitle-label", viewsubtitle_label.into()), }
                        }

                            pub fn show_left_title_buttons(self, show_left_title_buttons: bool) -> Self {
                            Self { builder: self.builder.property("show-left-title-buttons", show_left_title_buttons), }
                        }

                            pub fn show_right_title_buttons(self, show_right_title_buttons: bool) -> Self {
                            Self { builder: self.builder.property("show-right-title-buttons", show_right_title_buttons), }
                        }

                            pub fn decoration_layout(self, decoration_layout: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("decoration-layout", decoration_layout.into()), }
                        }

                            pub fn show_back(self, show_back: bool) -> Self {
                            Self { builder: self.builder.property("show-back", show_back), }
                        }
...
pub trait AppBarExt: IsA<AppBar> + sealed::Sealed + 'static {
    ...
    fn append(&self, child: &impl IsA<gtk::Widget>) {
        unsafe {
            ffi::he_app_bar_append(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0);
        }
    }
    ...
    fn remove(&self, child: &impl IsA<gtk::Widget>) {
        unsafe {
            ffi::he_app_bar_remove(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0);
        }
    }
    ...
    fn stack(&self) -> gtk::Stack {
        unsafe {
            from_glib_none(ffi::he_app_bar_get_stack(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn scroller(&self) -> gtk::ScrolledWindow {
        unsafe {
            from_glib_none(ffi::he_app_bar_get_scroller(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn is_compact(&self) -> bool {
        unsafe {
            from_glib(ffi::he_app_bar_get_is_compact(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn viewtitle_label(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_app_bar_get_viewtitle_label(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_viewtitle_label(&self, value: &str) {
        unsafe {
            ffi::he_app_bar_set_viewtitle_label(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn viewtitle_widget(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::he_app_bar_get_viewtitle_widget(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_viewtitle_widget(&self, value: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::he_app_bar_set_viewtitle_widget(self.as_ref().to_glib_none().0, value.map(|p| p.as_ref()).to_glib_none().0);
        }
    }
    ...
    fn viewsubtitle_label(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_app_bar_get_viewsubtitle_label(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_viewsubtitle_label(&self, value: &str) {
        unsafe {
            ffi::he_app_bar_set_viewsubtitle_label(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn shows_left_title_buttons(&self) -> bool {
        unsafe {
            from_glib(ffi::he_app_bar_get_show_left_title_buttons(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_show_left_title_buttons(&self, value: bool) {
        unsafe {
            ffi::he_app_bar_set_show_left_title_buttons(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }
    ...
    fn shows_right_title_buttons(&self) -> bool {
        unsafe {
            from_glib(ffi::he_app_bar_get_show_right_title_buttons(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_show_right_title_buttons(&self, value: bool) {
        unsafe {
            ffi::he_app_bar_set_show_right_title_buttons(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }
    ...
    fn decoration_layout(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_app_bar_get_decoration_layout(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_decoration_layout(&self, value: &str) {
        unsafe {
            ffi::he_app_bar_set_decoration_layout(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn shows_back(&self) -> bool {
        unsafe {
            from_glib(ffi::he_app_bar_get_show_back(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_stack_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stack_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::stack\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_stack_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "scroller")]
    fn connect_scroller_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_scroller_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::scroller\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_scroller_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "is-compact")]
    fn connect_is_compact_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_compact_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::is-compact\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_is_compact_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "viewtitle-label")]
    fn connect_viewtitle_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_viewtitle_label_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::viewtitle-label\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_viewtitle_label_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "viewtitle-widget")]
    fn connect_viewtitle_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_viewtitle_widget_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::viewtitle-widget\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_viewtitle_widget_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "viewsubtitle-label")]
    fn connect_viewsubtitle_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_viewsubtitle_label_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::viewsubtitle-label\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_viewsubtitle_label_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-left-title-buttons")]
    fn connect_show_left_title_buttons_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_left_title_buttons_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::show-left-title-buttons\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_show_left_title_buttons_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-right-title-buttons")]
    fn connect_show_right_title_buttons_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_right_title_buttons_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::show-right-title-buttons\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_show_right_title_buttons_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "decoration-layout")]
    fn connect_decoration_layout_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_decoration_layout_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::decoration-layout\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_decoration_layout_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-back")]
    fn connect_show_back_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_back_trampoline<P: IsA<AppBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeAppBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::show-back\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_show_back_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
