...
glib::wrapper! {
    ...
    pub struct PillButton(Object<ffi::HePillButton, ffi::HePillButtonClass>) @extends Button, gtk::Button, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
...
impl PillButton {
    ...
    pub fn new(label: &str) -> PillButton {
        ...
        unsafe {
            from_glib_none(ffi::he_pill_button_new(label.to_glib_none().0))
        }
    }
...
impl PillButtonBuilder {
    // rustdoc-stripper-ignore-next
    /// Create a new [`PillButtonBuilder`].
    pub fn new() -> Self {
        Self::default()
    }
...
if let Some(ref action_name) = self.action_name {
        ...
        glib::Object::new::<PillButton>(&properties)
