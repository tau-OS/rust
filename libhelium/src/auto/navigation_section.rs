...
glib::wrapper! {
    #[doc(alias = "HeNavigationSection")]
    pub struct NavigationSection(Object<ffi::HeNavigationSection, ffi::HeNavigationSectionClass>) @extends Bin, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::he_navigation_section_get_type(),
    }
}

impl NavigationSection {
        pub const NONE: Option<&'static NavigationSection> = None;
    

    #[doc(alias = "he_navigation_section_new")]
    pub fn new() -> NavigationSection {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_navigation_section_new())
        }
    }

            // rustdoc-stripper-ignore-next
            /// Creates a new builder-pattern struct instance to construct [`NavigationSection`] objects.
            ///
            /// This method returns an instance of [`NavigationSectionBuilder`](crate::builders::NavigationSectionBuilder) which can be used to create [`NavigationSection`] objects.
            pub fn builder() -> NavigationSectionBuilder {
                NavigationSectionBuilder::new()
            }
...
// rustdoc-stripper-ignore-next
        /// A [builder-pattern] type to construct [`NavigationSection`] objects.
        ///
        /// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct NavigationSectionBuilder {
            builder: glib::object::ObjectBuilder<'static, NavigationSection>,
        }

        impl NavigationSectionBuilder {
        fn new() -> Self {
...
pub trait NavigationSectionExt: IsA<NavigationSection> + sealed::Sealed + 'static {
    ...
    fn stack(&self) -> gtk::Stack {
        unsafe {
            from_glib_none(ffi::he_navigation_section_get_stack(self.as_ref().to_glib_none().0))
        }
    }

    #[doc(alias = "he_navigation_section_set_stack")]
    fn set_stack(&self, value: &gtk::Stack) {
        unsafe {
            ffi::he_navigation_section_set_stack(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    #[doc(alias = "he_navigation_section_get_orientation")]
    #[doc(alias = "get_orientation")]
    fn orientation(&self) -> gtk::Orientation {
        unsafe {
            from_glib(ffi::he_navigation_section_get_orientation(self.as_ref().to_glib_none().0))
        }
    }

    #[doc(alias = "he_navigation_section_set_orientation")]
    fn set_orientation(&self, value: gtk::Orientation) {
        unsafe {
            ffi::he_navigation_section_set_orientation(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }

    #[doc(alias = "stack")]
    fn connect_stack_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stack_trampoline<P: IsA<NavigationSection>, F: Fn(&P) + 'static>(this: *mut ffi::HeNavigationSection, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(NavigationSection::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_orientation_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_orientation_trampoline<P: IsA<NavigationSection>, F: Fn(&P) + 'static>(this: *mut ffi::HeNavigationSection, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(NavigationSection::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
...
impl<O: IsA<NavigationSection>> NavigationSectionExt for O {}
