...
glib::wrapper! {
    ...
    pub struct ContentBlock(Object<ffi::HeContentBlock, ffi::HeContentBlockClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl ContentBlock {
    ...
    pub fn new(title: &str, subtitle: &str, icon: &str, primary_button: &impl IsA<Button>, secondary_button: &impl IsA<Button>) -> ContentBlock {
        skip_assert_initialized!();
        unsafe {
            from_glib_none(ffi::he_content_block_new(title.to_glib_none().0, subtitle.to_glib_none().0, icon.to_glib_none().0, primary_button.as_ref().to_glib_none().0, secondary_button.as_ref().to_glib_none().0))
        }
    }
...
impl<O: IsA<ContentBlock>> ContentBlockExt for O {
    fn title(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_content_block_get_title(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn subtitle(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_content_block_get_subtitle(self.as_ref().to_glib_none().0))
        }
    }

    fn set_subtitle(&self, value: &str) {
        unsafe {
            ffi::he_content_block_set_subtitle(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn icon(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_content_block_get_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_gicon(&self, value: &impl IsA<gio::Icon>) {
        unsafe {
            ffi::he_content_block_set_gicon(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }

    fn secondary_button(&self) -> Button {
        unsafe {
            from_glib_none(ffi::he_content_block_get_secondary_button(self.as_ref().to_glib_none().0))
        }
    }

    fn set_secondary_button(&self, value: &impl IsA<Button>) {
        unsafe {
            ffi::he_content_block_set_secondary_button(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }

    fn primary_button(&self) -> Button {
        unsafe {
            from_glib_none(ffi::he_content_block_get_primary_button(self.as_ref().to_glib_none().0))
        }
    }

    fn set_primary_button(&self, value: &impl IsA<Button>) {
        unsafe {
            ffi::he_content_block_set_primary_button(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }

    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<ContentBlock>, F: Fn(&P) + 'static>(this: *mut ffi::HeContentBlock, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_subtitle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_subtitle_trampoline<P: IsA<ContentBlock>, F: Fn(&P) + 'static>(this: *mut ffi::HeContentBlock, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ContentBlock::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_trampoline<P: IsA<ContentBlock>, F: Fn(&P) + 'static>(this: *mut ffi::HeContentBlock, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ContentBlock::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_gicon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_gicon_trampoline<P: IsA<ContentBlock>, F: Fn(&P) + 'static>(this: *mut ffi::HeContentBlock, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ContentBlock::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_secondary_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_secondary_button_trampoline<P: IsA<ContentBlock>, F: Fn(&P) + 'static>(this: *mut ffi::HeContentBlock, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ContentBlock::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::secondary-button\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_secondary_button_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_primary_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_primary_button_trampoline<P: IsA<ContentBlock>, F: Fn(&P) + 'static>(this: *mut ffi::HeContentBlock, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ContentBlock::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
