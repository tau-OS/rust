...
glib::wrapper! {
    #[doc(alias = "HeWindow")]
    pub struct Window(Object<ffi::HeWindow, ffi::HeWindowClass>) @extends gtk::Window, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Native, gtk::Root, gtk::ShortcutManager;
...
impl Window {
    ...
    pub fn new() -> Window {
        ...
        unsafe {
            from_glib_none(ffi::he_window_new())
        }
    }
...
impl<O: IsA<Window>> WindowExt for O {
    fn parent(&self) -> Option<gtk::Window> {
        unsafe {
            from_glib_none(ffi::he_window_get_parent(self.as_ref().to_glib_none().0))
        }
    }

    fn set_parent(&self, value: Option<&impl IsA<gtk::Window>>) {
        unsafe {
            ffi::he_window_set_parent(self.as_ref().to_glib_none().0, value.map(|p| p.as_ref()).to_glib_none().0);
        }
    }

    fn is_modal(&self) -> bool {
        unsafe {
            from_glib(ffi::he_window_get_modal(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn has_title(&self) -> bool {
        unsafe {
            from_glib(ffi::he_window_get_has_title(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn has_back_button(&self) -> bool {
        unsafe {
            from_glib(ffi::he_window_get_has_back_button(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_parent_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_parent_trampoline<P: IsA<Window>, F: Fn(&P) + 'static>(this: *mut ffi::HeWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_has_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_has_title_trampoline<P: IsA<Window>, F: Fn(&P) + 'static>(this: *mut ffi::HeWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_has_back_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_has_back_button_trampoline<P: IsA<Window>, F: Fn(&P) + 'static>(this: *mut ffi::HeWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Window::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
