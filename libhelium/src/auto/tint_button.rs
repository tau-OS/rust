...
glib::wrapper! {
    ...
    pub struct TintButton(Object<ffi::HeTintButton, ffi::HeTintButtonClass>) @extends Button, gtk::Button, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;

    match fn {
        type_ => || ffi::he_tint_button_get_type(),
    }
}

impl TintButton {
        pub const NONE: Option<&'static TintButton> = None;
    

    #[doc(alias = "he_tint_button_new")]
    pub fn new(label: &str) -> TintButton {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_tint_button_new(label.to_glib_none().0))
        }
    }

    #[doc(alias = "he_tint_button_new_from_icon")]
    pub fn from_icon(icon: &str) -> TintButton {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_tint_button_new_from_icon(icon.to_glib_none().0))
        }
    }

            // rustdoc-stripper-ignore-next
            /// Creates a new builder-pattern struct instance to construct [`TintButton`] objects.
            ///
            /// This method returns an instance of [`TintButtonBuilder`](crate::builders::TintButtonBuilder) which can be used to create [`TintButton`] objects.
            pub fn builder() -> TintButtonBuilder {
                TintButtonBuilder::new()
            }
...
// rustdoc-stripper-ignore-next
        /// A [builder-pattern] type to construct [`TintButton`] objects.
        ///
        /// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct TintButtonBuilder {
            builder: glib::object::ObjectBuilder<'static, TintButton>,
        }

        impl TintButtonBuilder {
        fn new() -> Self {
