...
pub trait SideBarExt: IsA<SideBar> + sealed::Sealed + 'static {
    ...
    fn shows_right_title_buttons(&self) -> bool {
        unsafe {
            from_glib(ffi::he_side_bar_get_show_right_title_buttons(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn set_show_right_title_buttons(&self, value: bool) {
        unsafe {
            ffi::he_side_bar_set_show_right_title_buttons(
                self.as_ref().to_glib_none().0,
                value.into_glib(),
            );
        }
    ...
    fn shows_left_title_buttons(&self) -> bool {
        unsafe {
            from_glib(ffi::he_side_bar_get_show_left_title_buttons(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn set_show_left_title_buttons(&self, value: bool) {
        unsafe {
            ffi::he_side_bar_set_show_left_title_buttons(
                self.as_ref().to_glib_none().0,
                value.into_glib(),
            );
        }
