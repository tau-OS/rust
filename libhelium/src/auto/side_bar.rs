...
impl SideBar {
    ...
    pub fn new(title: &str, subtitle: &str) -> SideBar {
        ...
        unsafe {
            from_glib_none(ffi::he_side_bar_new(title.to_glib_none().0, subtitle.to_glib_none().0))
        }
    }
...
pub struct SideBarBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("titlewidget", titlewidget.clone().upcast()), }
                        }
...
pub trait SideBarExt: IsA<SideBar> + sealed::Sealed + 'static {
    ...
    fn title(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_side_bar_get_title(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn titlewidget(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::he_side_bar_get_titlewidget(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_titlewidget(&self, value: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::he_side_bar_set_titlewidget(self.as_ref().to_glib_none().0, value.map(|p| p.as_ref()).to_glib_none().0);
        }
    }
    ...
    fn subtitle(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_side_bar_get_subtitle(self.as_ref().to_glib_none().0))
        }
    }
    ...
    #[doc(alias = "he_side_bar_get_show_right_title_buttons")]
    #[doc(alias = "get_show_right_title_buttons")]
    fn shows_right_title_buttons(&self) -> bool {
        unsafe {
            from_glib(ffi::he_side_bar_get_show_right_title_buttons(self.as_ref().to_glib_none().0))
        }
    }

    #[doc(alias = "he_side_bar_set_show_right_title_buttons")]
    fn set_show_right_title_buttons(&self, value: bool) {
        unsafe {
            ffi::he_side_bar_set_show_right_title_buttons(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }

    #[doc(alias = "he_side_bar_get_show_left_title_buttons")]
    #[doc(alias = "get_show_left_title_buttons")]
    fn shows_left_title_buttons(&self) -> bool {
        unsafe {
            from_glib(ffi::he_side_bar_get_show_left_title_buttons(self.as_ref().to_glib_none().0))
        }
    }

    #[doc(alias = "he_side_bar_set_show_left_title_buttons")]
    fn set_show_left_title_buttons(&self, value: bool) {
        unsafe {
            ffi::he_side_bar_set_show_left_title_buttons(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }
    ...
    fn shows_back(&self) -> bool {
        unsafe {
            from_glib(ffi::he_side_bar_get_show_back(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn stack(&self) -> gtk::Stack {
        unsafe {
            from_glib_none(ffi::he_side_bar_get_stack(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn scroller(&self) -> gtk::ScrolledWindow {
        unsafe {
            from_glib_none(ffi::he_side_bar_get_scroller(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn has_margins(&self) -> bool {
        unsafe {
            from_glib(ffi::he_side_bar_get_has_margins(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<SideBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSideBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_titlewidget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_titlewidget_trampoline<P: IsA<SideBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSideBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SideBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::titlewidget\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_titlewidget_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "subtitle")]
    fn connect_subtitle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_subtitle_trampoline<P: IsA<SideBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSideBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SideBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::subtitle\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_subtitle_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-right-title-buttons")]
    fn connect_show_right_title_buttons_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_right_title_buttons_trampoline<P: IsA<SideBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSideBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SideBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_show_left_title_buttons_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_left_title_buttons_trampoline<P: IsA<SideBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSideBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SideBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_show_back_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_back_trampoline<P: IsA<SideBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSideBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SideBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_stack_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stack_trampoline<P: IsA<SideBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSideBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SideBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_scroller_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_scroller_trampoline<P: IsA<SideBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSideBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SideBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_has_margins_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_has_margins_trampoline<P: IsA<SideBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSideBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SideBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::has-margins\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_has_margins_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
