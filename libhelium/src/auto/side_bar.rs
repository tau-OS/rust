...
glib::wrapper! {
    #[doc(alias = "HeSideBar")]
    pub struct SideBar(Object<ffi::HeSideBar, ffi::HeSideBarClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl<O: IsA<SideBar>> SideBarExt for O {
    ...
    fn shows_buttons(&self) -> bool {
        unsafe {
            from_glib(ffi::he_side_bar_get_show_buttons(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_show_buttons_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_buttons_trampoline<P: IsA<SideBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSideBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SideBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
