...
glib::wrapper! {
    ...
    pub struct IconicButton(Object<ffi::HeIconicButton, ffi::HeIconicButtonClass>) @extends Button, gtk::Button, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
