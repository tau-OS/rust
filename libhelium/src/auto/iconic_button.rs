...
glib::wrapper! {
    ...
    pub struct IconicButton(Object<ffi::HeIconicButton, ffi::HeIconicButtonClass>) @extends Button, gtk::Button, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
...
impl IconicButton {
    ...
    pub fn new(icon: &str) -> IconicButton {
        ...
        unsafe {
            from_glib_none(ffi::he_iconic_button_new(icon.to_glib_none().0))
        }
    }
...
pub struct IconicButtonBuilder {
            builder: glib::object::ObjectBuilder<'static, IconicButton>,
        }
...
pub trait IconicButtonExt: IsA<IconicButton> + sealed::Sealed + 'static {
    ...
    fn icon(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_iconic_button_get_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn tooltip(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_iconic_button_get_tooltip(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_tooltip(&self, value: &str) {
        unsafe {
            ffi::he_iconic_button_set_tooltip(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    #[doc(alias = "tooltip")]
    fn connect_tooltip_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_tooltip_trampoline<P: IsA<IconicButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeIconicButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
