...
glib::wrapper! {
    ...
    pub struct NavigationRail(Object<ffi::HeNavigationRail, ffi::HeNavigationRailClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
