...
impl NavigationRail {
    ...
    pub fn new() -> NavigationRail {
        ...
        unsafe {
            from_glib_none(ffi::he_navigation_rail_new())
        }
    }
...
pub trait NavigationRailExt: IsA<NavigationRail> + sealed::Sealed + 'static {
    ...
    fn stack(&self) -> gtk::Stack {
        unsafe {
            from_glib_none(ffi::he_navigation_rail_get_stack(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_stack(&self, value: &gtk::Stack) {
        unsafe {
            ffi::he_navigation_rail_set_stack(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn orientation(&self) -> gtk::Orientation {
        unsafe {
            from_glib(ffi::he_navigation_rail_get_orientation(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_orientation(&self, value: gtk::Orientation) {
        unsafe {
            ffi::he_navigation_rail_set_orientation(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }

    #[doc(alias = "stack")]
    fn connect_stack_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stack_trampoline<P: IsA<NavigationRail>, F: Fn(&P) + 'static>(this: *mut ffi::HeNavigationRail, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_orientation_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_orientation_trampoline<P: IsA<NavigationRail>, F: Fn(&P) + 'static>(this: *mut ffi::HeNavigationRail, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(NavigationRail::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
