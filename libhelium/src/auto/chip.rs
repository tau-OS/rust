...
impl Chip {
    ...
    pub fn new(label: &str) -> Chip {
        ...
        unsafe {
            from_glib_none(ffi::he_chip_new(label.to_glib_none().0))
        }
    }
...
pub struct ChipBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("chip-label", chip_label.into()), }
                        }
...
pub trait ChipExt: IsA<Chip> + sealed::Sealed + 'static {
    ...
    fn chip_label(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_chip_get_chip_label(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_chip_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_chip_label_trampoline<P: IsA<Chip>, F: Fn(&P) + 'static>(this: *mut ffi::HeChip, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Chip::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::chip-label\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_chip_label_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
