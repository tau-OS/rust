...
glib::wrapper! {
    #[doc(alias = "HeChip")]
    pub struct Chip(Object<ffi::HeChip, ffi::HeChipClass>) @extends Button, gtk::Button, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
...
if let Some(ref action_name) = self.action_name {
        ...
        glib::Object::new::<Chip>(&properties)
