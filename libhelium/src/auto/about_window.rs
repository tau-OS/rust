...
impl AboutWindow {
    ...
    pub fn new(parent: &impl IsA<gtk::Window>, app_name: &str, app_id: &str, version: &str, icon: &str, translate_url: Option<&str>, issue_url: Option<&str>, more_info_url: Option<&str>, translators: &[&str], developers: &[&str], copyright_year: i32, license: AboutWindowLicenses, color: Colors) -> AboutWindow {
        assert_initialized_main_thread!();
        let translators_length1 = translators.len() as _;
        let developers_length1 = developers.len() as _;
        unsafe {
            from_glib_none(ffi::he_about_window_new(parent.as_ref().to_glib_none().0, app_name.to_glib_none().0, app_id.to_glib_none().0, version.to_glib_none().0, icon.to_glib_none().0, translate_url.to_glib_none().0, issue_url.to_glib_none().0, more_info_url.to_glib_none().0, translators.to_glib_none().0, translators_length1, developers.to_glib_none().0, developers_length1, copyright_year, license.into_glib(), color.into_glib()))
        }
    }
...
pub struct AboutWindowBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("color", color), }
                        }

                            pub fn license(self, license: AboutWindowLicenses) -> Self {
                            Self { builder: self.builder.property("license", license), }
                        }
                            ...
                            Self { builder: self.builder.property("translator-names", translator_names.into()), }
                        }

                            pub fn developer_names(self, developer_names: impl Into<glib::StrV>) -> Self {
                            Self { builder: self.builder.property("developer-names", developer_names.into()), }
                        }

                            pub fn copyright_year(self, copyright_year: i32) -> Self {
                            Self { builder: self.builder.property("copyright-year", copyright_year), }
                        }
                            ...
                            Self { builder: self.builder.property("translate-url", translate_url.into()), }
                        }

                            pub fn issue_url(self, issue_url: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("issue-url", issue_url.into()), }
                        }

                            pub fn more_info_url(self, more_info_url: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("more-info-url", more_info_url.into()), }
                        }
...
pub trait AboutWindowExt: IsA<AboutWindow> + sealed::Sealed + 'static {
    ...
    fn color(&self) -> Colors {
        unsafe {
            from_glib(ffi::he_about_window_get_color(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn license(&self) -> AboutWindowLicenses {
        unsafe {
            from_glib(ffi::he_about_window_get_license(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn version(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_about_window_get_version(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_version(&self, value: &str) {
        unsafe {
            ffi::he_about_window_set_version(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn app_name(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_about_window_get_app_name(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_app_name(&self, value: &str) {
        unsafe {
            ffi::he_about_window_set_app_name(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn icon(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_about_window_get_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn translator_names(&self) -> Vec<glib::GString> {
        unsafe {
            ...
            let ret = FromGlibContainer::from_glib_none_num(ffi::he_about_window_get_translator_names(self.as_ref().to_glib_none().0, result_length1.as_mut_ptr()), result_length1.assume_init() as _);
            ret
        }
    }
    ...
    fn set_translator_names(&self, value: &[&str]) {
        ...
        unsafe {
            ffi::he_about_window_set_translator_names(self.as_ref().to_glib_none().0, value.to_glib_none().0, value_length1);
        }
    }
    ...
    fn developer_names(&self) -> Vec<glib::GString> {
        unsafe {
            let mut result_length1 = std::mem::MaybeUninit::uninit();
            let ret = FromGlibContainer::from_glib_none_num(ffi::he_about_window_get_developer_names(self.as_ref().to_glib_none().0, result_length1.as_mut_ptr()), result_length1.assume_init() as _);
            ret
        }
    }
    ...
    fn set_developer_names(&self, value: &[&str]) {
        let value_length1 = value.len() as _;
        unsafe {
            ffi::he_about_window_set_developer_names(self.as_ref().to_glib_none().0, value.to_glib_none().0, value_length1);
        }
    }
    ...
    fn copyright_year(&self) -> i32 {
        unsafe {
            ffi::he_about_window_get_copyright_year(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn app_id(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_about_window_get_app_id(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn translate_url(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::he_about_window_get_translate_url(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_translate_url(&self, value: Option<&str>) {
        unsafe {
            ffi::he_about_window_set_translate_url(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn issue_url(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::he_about_window_get_issue_url(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_issue_url(&self, value: Option<&str>) {
        unsafe {
            ffi::he_about_window_set_issue_url(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn more_info_url(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::he_about_window_get_more_info_url(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_more_info_url(&self, value: Option<&str>) {
        unsafe {
            ffi::he_about_window_set_more_info_url(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    #[doc(alias = "color")]
    fn connect_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_color_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_license_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_license_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::license\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_license_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "version")]
    fn connect_version_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_version_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_app_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_app_name_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_translator_names_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_translator_names_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::translator-names\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_translator_names_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "developer-names")]
    fn connect_developer_names_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_developer_names_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::developer-names\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_developer_names_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "copyright-year")]
    fn connect_copyright_year_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_copyright_year_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::copyright-year\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_copyright_year_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "app-id")]
    fn connect_app_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_app_id_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::app-id\0".as_ptr() as *const _,
    ...
    fn connect_translate_url_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_translate_url_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::translate-url\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_translate_url_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "issue-url")]
    fn connect_issue_url_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_issue_url_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::issue-url\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_issue_url_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "more-info-url")]
    fn connect_more_info_url_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_more_info_url_trampoline<P: IsA<AboutWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeAboutWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::more-info-url\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_more_info_url_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
