...
impl SettingsRow {
    ...
    pub fn with_details(title: Option<&str>, subtitle: Option<&str>, primary_button: Option<&impl IsA<Button>>) -> SettingsRow {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_settings_row_new_with_details(title.to_glib_none().0, subtitle.to_glib_none().0, primary_button.map(|p| p.as_ref()).to_glib_none().0))
        }
    }
    ...
    pub fn new() -> SettingsRow {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_settings_row_new())
        }
    }
...
pub struct SettingsRowBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("paintable", paintable.clone().upcast()), }
                        }
                            ...
                            Self { builder: self.builder.property("activatable-widget", activatable_widget.clone().upcast()), }
                        }
...
pub trait SettingsRowExt: IsA<SettingsRow> + sealed::Sealed + 'static {
    ...
    fn add(&self, child: &impl IsA<gtk::Widget>) {
        unsafe {
            ffi::he_settings_row_add(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0);
        }
    }
    ...
    fn title(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_settings_row_get_title(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn subtitle(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_settings_row_get_subtitle(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_subtitle(&self, value: &str) {
        unsafe {
            ffi::he_settings_row_set_subtitle(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn icon(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_settings_row_get_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_gicon(&self, value: &impl IsA<gio::Icon>) {
        unsafe {
            ffi::he_settings_row_set_gicon(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }
    ...
    fn set_paintable(&self, value: &impl IsA<gdk::Paintable>) {
        unsafe {
            ffi::he_settings_row_set_paintable(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }
    ...
    fn primary_button(&self) -> Button {
        unsafe {
            from_glib_none(ffi::he_settings_row_get_primary_button(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_primary_button(&self, value: &impl IsA<Button>) {
        unsafe {
            ffi::he_settings_row_set_primary_button(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }
    ...
    fn activatable_widget(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::he_settings_row_get_activatable_widget(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_activatable_widget(&self, value: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::he_settings_row_set_activatable_widget(self.as_ref().to_glib_none().0, value.map(|p| p.as_ref()).to_glib_none().0);
        }
    }

    #[doc(alias = "activated")]
    fn connect_activated<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn activated_trampoline<P: IsA<SettingsRow>, F: Fn(&P) + 'static>(this: *mut ffi::HeSettingsRow, f: glib::ffi::gpointer) {
    ...
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<SettingsRow>, F: Fn(&P) + 'static>(this: *mut ffi::HeSettingsRow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsRow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_subtitle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_subtitle_trampoline<P: IsA<SettingsRow>, F: Fn(&P) + 'static>(this: *mut ffi::HeSettingsRow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsRow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_trampoline<P: IsA<SettingsRow>, F: Fn(&P) + 'static>(this: *mut ffi::HeSettingsRow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsRow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_gicon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_gicon_trampoline<P: IsA<SettingsRow>, F: Fn(&P) + 'static>(this: *mut ffi::HeSettingsRow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsRow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_paintable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_paintable_trampoline<P: IsA<SettingsRow>, F: Fn(&P) + 'static>(this: *mut ffi::HeSettingsRow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsRow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::paintable\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_paintable_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "primary-button")]
    fn connect_primary_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_primary_button_trampoline<P: IsA<SettingsRow>, F: Fn(&P) + 'static>(this: *mut ffi::HeSettingsRow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsRow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_activatable_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_activatable_widget_trampoline<P: IsA<SettingsRow>, F: Fn(&P) + 'static>(this: *mut ffi::HeSettingsRow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SettingsRow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::activatable-widget\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_activatable_widget_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
