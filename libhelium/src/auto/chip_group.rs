...
impl ChipGroup {
    ...
    pub fn new() -> ChipGroup {
        ...
        unsafe {
            from_glib_none(ffi::he_chip_group_new())
        }
    }
...
pub struct ChipGroupBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("selection-model", selection_model.clone()), }
                        }

                            pub fn single_line(self, single_line: bool) -> Self {
                            Self { builder: self.builder.property("single-line", single_line), }
                        }
...
pub trait ChipGroupExt: IsA<ChipGroup> + sealed::Sealed + 'static {
    ...
    fn selection_model(&self) -> gtk::SingleSelection {
        unsafe {
            from_glib_none(ffi::he_chip_group_get_selection_model(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_selection_model(&self, value: &gtk::SingleSelection) {
        unsafe {
            ffi::he_chip_group_set_selection_model(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn is_single_line(&self) -> bool {
        unsafe {
            from_glib(ffi::he_chip_group_get_single_line(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_selection_model_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_selection_model_trampoline<P: IsA<ChipGroup>, F: Fn(&P) + 'static>(this: *mut ffi::HeChipGroup, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ChipGroup::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::selection-model\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_selection_model_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "single-line")]
    fn connect_single_line_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_single_line_trampoline<P: IsA<ChipGroup>, F: Fn(&P) + 'static>(this: *mut ffi::HeChipGroup, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ChipGroup::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::single-line\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_single_line_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
