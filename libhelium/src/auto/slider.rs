...
impl Slider {
    ...
    pub fn new() -> Slider {
        ...
        unsafe {
            from_glib_none(ffi::he_slider_new())
        }
    }
...
pub struct SliderBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("left-icon", left_icon.into()), }
                        }

                            pub fn right_icon(self, right_icon: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("right-icon", right_icon.into()), }
                        }

                            pub fn stop_indicator_visibility(self, stop_indicator_visibility: bool) -> Self {
                            Self { builder: self.builder.property("stop-indicator-visibility", stop_indicator_visibility), }
                        }
...
pub trait SliderExt: IsA<Slider> + sealed::Sealed + 'static {
    ...
    fn left_icon(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_slider_get_left_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn right_icon(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_slider_get_right_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn is_stop_indicator_visibility(&self) -> bool {
        unsafe {
            from_glib(ffi::he_slider_get_stop_indicator_visibility(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_stop_indicator_visibility(&self, value: bool) {
        unsafe {
            ffi::he_slider_set_stop_indicator_visibility(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }

    #[doc(alias = "left-icon")]
    fn connect_left_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_left_icon_trampoline<P: IsA<Slider>, F: Fn(&P) + 'static>(this: *mut ffi::HeSlider, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Slider::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::left-icon\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_left_icon_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "right-icon")]
    fn connect_right_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_right_icon_trampoline<P: IsA<Slider>, F: Fn(&P) + 'static>(this: *mut ffi::HeSlider, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Slider::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::right-icon\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_right_icon_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "stop-indicator-visibility")]
    fn connect_stop_indicator_visibility_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stop_indicator_visibility_trampoline<P: IsA<Slider>, F: Fn(&P) + 'static>(this: *mut ffi::HeSlider, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Slider::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::stop-indicator-visibility\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_stop_indicator_visibility_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
