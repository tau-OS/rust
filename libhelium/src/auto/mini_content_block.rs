...
glib::wrapper! {
    ...
    pub struct MiniContentBlock(Object<ffi::HeMiniContentBlock, ffi::HeMiniContentBlockClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
