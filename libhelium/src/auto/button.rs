...
impl Button {
    ...
    pub fn new(icon: Option<&str>, text: Option<&str>) -> Button {
        ...
        unsafe {
            from_glib_none(ffi::he_button_new(icon.to_glib_none().0, text.to_glib_none().0))
        }
    }
...
pub struct ButtonBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("is-disclosure", is_disclosure), }
                        }

                            pub fn is_iconic(self, is_iconic: bool) -> Self {
                            Self { builder: self.builder.property("is-iconic", is_iconic), }
                        }
                            ...
                            Self { builder: self.builder.property("is-tint", is_tint), }
                        }

                            pub fn is_fill(self, is_fill: bool) -> Self {
                            Self { builder: self.builder.property("is-fill", is_fill), }
                        }

                            pub fn is_pill(self, is_pill: bool) -> Self {
                            Self { builder: self.builder.property("is-pill", is_pill), }
                        }

                            pub fn is_textual(self, is_textual: bool) -> Self {
                            Self { builder: self.builder.property("is-textual", is_textual), }
                        }
    ...
    pub fn can_shrink(self, can_shrink: bool) -> Self {
                            Self { builder: self.builder.property("can-shrink", can_shrink), }
                        }
...
pub trait HeButtonExt: IsA<Button> + sealed::Sealed + 'static {
    ...
    fn is_disclosure(&self) -> bool {
        unsafe {
            from_glib(ffi::he_button_get_is_disclosure(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn is_iconic(&self) -> bool {
        unsafe {
            from_glib(ffi::he_button_get_is_iconic(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn is_outline(&self) -> bool {
        unsafe {
            from_glib(ffi::he_button_get_is_outline(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn is_tint(&self) -> bool {
        unsafe {
            from_glib(ffi::he_button_get_is_tint(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn fills(&self) -> bool {
        unsafe {
            from_glib(ffi::he_button_get_is_fill(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn is_pill(&self) -> bool {
        unsafe {
            from_glib(ffi::he_button_get_is_pill(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn is_textual(&self) -> bool {
        unsafe {
            from_glib(ffi::he_button_get_is_textual(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn icon(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::he_button_get_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn text(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_button_get_text(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_is_disclosure_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_disclosure_trampoline<P: IsA<Button>, F: Fn(&P) + 'static>(this: *mut ffi::HeButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Button::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::is-disclosure\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_is_disclosure_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "is-iconic")]
    fn connect_is_iconic_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_iconic_trampoline<P: IsA<Button>, F: Fn(&P) + 'static>(this: *mut ffi::HeButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Button::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::is-iconic\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_is_iconic_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "is-outline")]
    fn connect_is_outline_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_outline_trampoline<P: IsA<Button>, F: Fn(&P) + 'static>(this: *mut ffi::HeButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Button::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_is_tint_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_tint_trampoline<P: IsA<Button>, F: Fn(&P) + 'static>(this: *mut ffi::HeButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Button::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::is-tint\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_is_tint_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "is-fill")]
    fn connect_is_fill_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_fill_trampoline<P: IsA<Button>, F: Fn(&P) + 'static>(this: *mut ffi::HeButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Button::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::is-fill\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_is_fill_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "is-pill")]
    fn connect_is_pill_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_pill_trampoline<P: IsA<Button>, F: Fn(&P) + 'static>(this: *mut ffi::HeButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Button::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::is-pill\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_is_pill_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "is-textual")]
    fn connect_is_textual_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_textual_trampoline<P: IsA<Button>, F: Fn(&P) + 'static>(this: *mut ffi::HeButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Button::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::is-textual\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_is_textual_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_text_trampoline<P: IsA<Button>, F: Fn(&P) + 'static>(this: *mut ffi::HeButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Button::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
