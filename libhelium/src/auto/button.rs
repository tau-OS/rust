...
glib::wrapper! {
    #[doc(alias = "HeButton")]
    pub struct Button(Object<ffi::HeButton, ffi::HeButtonClass>) @extends gtk::Button, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
