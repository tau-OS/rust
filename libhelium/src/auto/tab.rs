...
pub struct TabBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("tooltip", tooltip.into()), }
                        }
                            ...
                            Self { builder: self.builder.property("can-pin", can_pin), }
                        }

                            pub fn can_close(self, can_close: bool) -> Self {
                            Self { builder: self.builder.property("can-close", can_close), }
                        }

                            pub fn page(self, page: &impl IsA<gtk::Widget>) -> Self {
                            Self { builder: self.builder.property("page", page.clone().upcast()), }
                        }
    ...
    fn connect_can_pin_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::can-pin\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_can_pin_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_can_close_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::can-close\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_can_close_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
