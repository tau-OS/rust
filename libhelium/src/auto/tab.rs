...
glib::wrapper! {
    #[doc(alias = "HeTab")]
    pub struct Tab(Object<ffi::HeTab, ffi::HeTabClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl<O: IsA<Tab>> TabExt for O {
    ...
    fn is_pinned(&self) -> bool {
        unsafe {
            from_glib(ffi::he_tab_get_pinned(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn can_pin(&self) -> bool {
        unsafe {
            from_glib(ffi::he_tab_get_can_pin(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn can_close(&self) -> bool {
        unsafe {
            from_glib(ffi::he_tab_get_can_close(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_pinned_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_pinned_trampoline<P: IsA<Tab>, F: Fn(&P) + 'static>(this: *mut ffi::HeTab, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Tab::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::pinned\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_pinned_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_can_pin_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_can_pin_trampoline<P: IsA<Tab>, F: Fn(&P) + 'static>(this: *mut ffi::HeTab, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Tab::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::can-pin\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_can_pin_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_can_close_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_can_close_trampoline<P: IsA<Tab>, F: Fn(&P) + 'static>(this: *mut ffi::HeTab, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Tab::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::can-close\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_can_close_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
