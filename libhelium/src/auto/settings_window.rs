...
use crate::{ffi,SettingsList,SettingsPage,Window};
use glib::{prelude::*,translate::*};

glib::wrapper! {
    #[doc(alias = "HeSettingsWindow")]
    pub struct SettingsWindow(Object<ffi::HeSettingsWindow, ffi::HeSettingsWindowClass>) @extends Window, gtk::Window, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Native, gtk::Root, gtk::ShortcutManager;
...
pub struct SettingsWindowBuilder {
            builder: glib::object::ObjectBuilder<'static, SettingsWindow>,
        }
