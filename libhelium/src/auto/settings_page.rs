...
glib::wrapper! {
    ...
    pub struct SettingsPage(Object<ffi::HeSettingsPage, ffi::HeSettingsPageClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
