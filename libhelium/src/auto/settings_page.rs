...
use crate::{ffi, Bin, SettingsList};
use glib::{
    prelude::*,
...
impl SettingsPage {
    ...
    pub fn new(title: &str) -> SettingsPage {
        ...
        unsafe { from_glib_none(ffi::he_settings_page_new(title.to_glib_none().0)) }
    }
...
pub struct SettingsPageBuilder {
    builder: glib::object::ObjectBuilder<'static, SettingsPage>,
}
