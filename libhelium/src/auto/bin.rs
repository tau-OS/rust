...
glib::wrapper! {
    #[doc(alias = "HeBin")]
    pub struct Bin(Object<ffi::HeBin, ffi::HeBinClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl Bin {
    ...
    #[doc(alias = "he_bin_new")]
    pub fn new() -> Bin {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_bin_new())
        }
    }
...
impl<O: IsA<Bin>> BinExt for O {
    fn child(&self) -> gtk::Widget {
        unsafe {
            from_glib_none(ffi::he_bin_get_child(self.as_ref().to_glib_none().0))
        }
    }

    fn set_child(&self, value: &impl IsA<gtk::Widget>) {
        unsafe {
            ffi::he_bin_set_child(self.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }
    ...
    fn connect_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_trampoline<P: IsA<Bin>, F: Fn(&P) + 'static>(this: *mut ffi::HeBin, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
