...
glib::wrapper! {
    #[doc(alias = "HeBadge")]
    pub struct Badge(Object<ffi::HeBadge, ffi::HeBadgeClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl Badge {
    ...
    pub fn new() -> Badge {
        ...
        unsafe {
            from_glib_none(ffi::he_badge_new())
        }
    }
...
if let Some(ref width_request) = self.width_request {
        ...
        glib::Object::new::<Badge>(&properties)
...
impl<O: IsA<Badge>> BadgeExt for O {
    fn child(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::he_badge_get_child(self.as_ref().to_glib_none().0))
        }
    }

    fn set_child(&self, value: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::he_badge_set_child(self.as_ref().to_glib_none().0, value.map(|p| p.as_ref()).to_glib_none().0);
        }
    }

    fn label(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::he_badge_get_label(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_label_trampoline<P: IsA<Badge>, F: Fn(&P) + 'static>(this: *mut ffi::HeBadge, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
