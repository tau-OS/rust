...
glib::wrapper! {
    ...
    pub struct ViewMono(Object<ffi::HeViewMono, ffi::HeViewMonoClass>) @extends View, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
