...
impl Desktop {
    ...
    pub fn new() -> Desktop {
        ...
        unsafe {
            from_glib_full(ffi::he_desktop_new())
        }
    }
...
pub struct DesktopBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("accent-color", accent_color), }
                        }

                            pub fn font_weight(self, font_weight: f64) -> Self {
                            Self { builder: self.builder.property("font-weight", font_weight), }
                        }
...
pub trait DesktopExt: IsA<Desktop> + sealed::Sealed + 'static {
    ...
    fn prefers_color_scheme(&self) -> DesktopColorScheme {
        unsafe {
            from_glib(ffi::he_desktop_get_prefers_color_scheme(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_prefers_color_scheme(&self, value: DesktopColorScheme) {
        unsafe {
            ffi::he_desktop_set_prefers_color_scheme(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }
    ...
    fn ensor_scheme(&self) -> DesktopEnsorScheme {
        unsafe {
            from_glib(ffi::he_desktop_get_ensor_scheme(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn font_weight(&self) -> f64 {
        unsafe {
            ffi::he_desktop_get_font_weight(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn roundness(&self) -> f64 {
        unsafe {
            ffi::he_desktop_get_roundness(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn connect_prefers_color_scheme_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_prefers_color_scheme_trampoline<P: IsA<Desktop>, F: Fn(&P) + 'static>(this: *mut ffi::HeDesktop, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::prefers-color-scheme\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_prefers_color_scheme_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "ensor-scheme")]
    fn connect_ensor_scheme_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_ensor_scheme_trampoline<P: IsA<Desktop>, F: Fn(&P) + 'static>(this: *mut ffi::HeDesktop, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Desktop::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::ensor-scheme\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_ensor_scheme_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_accent_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accent-color\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accent_color_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "font-weight")]
    fn connect_font_weight_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_font_weight_trampoline<P: IsA<Desktop>, F: Fn(&P) + 'static>(this: *mut ffi::HeDesktop, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Desktop::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::font-weight\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_font_weight_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "roundness")]
    fn connect_roundness_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_roundness_trampoline<P: IsA<Desktop>, F: Fn(&P) + 'static>(this: *mut ffi::HeDesktop, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Desktop::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::roundness\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_roundness_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "contrast")]
    fn connect_contrast_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_contrast_trampoline<P: IsA<Desktop>, F: Fn(&P) + 'static>(this: *mut ffi::HeDesktop, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Desktop::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::contrast\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_contrast_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
