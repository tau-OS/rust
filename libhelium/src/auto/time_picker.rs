...
glib::wrapper! {
    ...
    pub struct TimePicker(Object<ffi::HeTimePicker, ffi::HeTimePickerClass>) @extends gtk::Entry, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::CellEditable, gtk::Editable;

    match fn {
        type_ => || ffi::he_time_picker_get_type(),
    }
}
...
impl TimePicker {
    ...
    #[doc(alias = "he_time_picker_new_with_format")]
    pub fn with_format(format_12: &str, format_24: &str) -> TimePicker {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_time_picker_new_with_format(format_12.to_glib_none().0, format_24.to_glib_none().0))
        }
    }

    #[doc(alias = "he_time_picker_new")]
    pub fn new() -> TimePicker {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_time_picker_new())
        }
    }
...
pub struct TimePickerBuilder {
    ...
    //pub fn completion(self, completion: /*Ignored*/&gtk::EntryCompletion) -> Self {
                        ...
                        //}
                            ...
                            pub fn secondary_icon_paintable(self, secondary_icon_paintable: &impl IsA<gdk::Paintable>) -> Self {
...
pub trait TimePickerExt: IsA<TimePicker> + sealed::Sealed + 'static {
    ...
    fn format_12(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_time_picker_get_format_12(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn format_24(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_time_picker_get_format_24(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn time(&self) -> glib::DateTime {
        unsafe {
            from_glib_none(ffi::he_time_picker_get_time(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_time_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn time_changed_trampoline<P: IsA<TimePicker>, F: Fn(&P) + 'static>(this: *mut ffi::HeTimePicker, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"time-changed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(time_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "time")]
    fn connect_time_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_time_trampoline<P: IsA<TimePicker>, F: Fn(&P) + 'static>(this: *mut ffi::HeTimePicker, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(TimePicker::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
