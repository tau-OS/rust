...
impl Toast {
    ...
    pub fn new(label: &str) -> Toast {
        ...
        unsafe { from_glib_none(ffi::he_toast_new(label.to_glib_none().0)) }
    }
...
impl ToastBuilder {
    ...
    pub fn default_action(self, default_action: impl Into<glib::GString>) -> Self {
        Self {
            builder: self
                .builder
                .property("default-action", default_action.into()),
        }
    }
...
pub trait ToastExt: IsA<Toast> + 'static {
    ...
    fn connect_default_action_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::default-action".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
