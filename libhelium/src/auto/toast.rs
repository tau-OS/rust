...
glib::wrapper! {
    #[doc(alias = "HeToast")]
    pub struct Toast(Object<ffi::HeToast, ffi::HeToastClass>) @extends Bin, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
pub struct ToastBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            pub fn default_action(self, default_action: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("default-action", default_action.into()), }
                        }
    ...
    fn connect_action<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"action\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(action_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_default_action_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::default-action\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_default_action_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
