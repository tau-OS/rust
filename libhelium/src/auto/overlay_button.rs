...
impl OverlayButton {
    ...
    pub fn new(icon: &str, label: Option<&str>, secondary_icon: Option<&str>) -> OverlayButton {
        ...
        unsafe {
            from_glib_none(ffi::he_overlay_button_new(icon.to_glib_none().0, label.to_glib_none().0, secondary_icon.to_glib_none().0))
        }
    }
...
pub struct OverlayButtonBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("typeb", typeb), }
                        }

                            pub fn typeb2(self, typeb2: OverlayButtonTypeButton) -> Self {
                            Self { builder: self.builder.property("typeb2", typeb2), }
                        }
                            ...
                            Self { builder: self.builder.property("secondary-color", secondary_color), }
                        }

                            pub fn secondary_icon(self, secondary_icon: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("secondary-icon", secondary_icon.into()), }
                        }
                            ...
                            Self { builder: self.builder.property("primary-tooltip", primary_tooltip.into()), }
                        }

                            pub fn secondary_tooltip(self, secondary_tooltip: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("secondary-tooltip", secondary_tooltip.into()), }
                        }
                            ...
                            Self { builder: self.builder.property("alignment", alignment), }
                        }
...
pub trait OverlayButtonExt: IsA<OverlayButton> + sealed::Sealed + 'static {
    ...
    fn size(&self) -> OverlayButtonSize {
        unsafe {
            from_glib(ffi::he_overlay_button_get_size(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn typeb(&self) -> OverlayButtonTypeButton {
        unsafe {
            from_glib(ffi::he_overlay_button_get_typeb(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn typeb2(&self) -> OverlayButtonTypeButton {
        unsafe {
            from_glib(ffi::he_overlay_button_get_typeb2(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn color(&self) -> Colors {
        unsafe {
            from_glib(ffi::he_overlay_button_get_color(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn secondary_color(&self) -> Colors {
        unsafe {
            from_glib(ffi::he_overlay_button_get_secondary_color(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_secondary_color(&self, value: Colors) {
        unsafe {
            ffi::he_overlay_button_set_secondary_color(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }
    ...
    fn secondary_icon(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_full(ffi::he_overlay_button_get_secondary_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_secondary_icon(&self, value: Option<&str>) {
        unsafe {
            ffi::he_overlay_button_set_secondary_icon(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn icon(&self) -> glib::GString {
        unsafe {
            from_glib_full(ffi::he_overlay_button_get_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn label(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::he_overlay_button_get_label(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_label(&self, value: Option<&str>) {
        unsafe {
            ffi::he_overlay_button_set_label(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn primary_tooltip(&self) -> glib::GString {
        unsafe {
            from_glib_full(ffi::he_overlay_button_get_primary_tooltip(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_primary_tooltip(&self, value: &str) {
        unsafe {
            ffi::he_overlay_button_set_primary_tooltip(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn secondary_tooltip(&self) -> glib::GString {
        unsafe {
            from_glib_full(ffi::he_overlay_button_get_secondary_tooltip(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_secondary_tooltip(&self, value: &str) {
        unsafe {
            ffi::he_overlay_button_set_secondary_tooltip(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn child(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::he_overlay_button_get_child(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_child(&self, value: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::he_overlay_button_set_child(self.as_ref().to_glib_none().0, value.map(|p| p.as_ref()).to_glib_none().0);
        }
    }
    ...
    fn alignment(&self) -> OverlayButtonAlignment {
        unsafe {
            from_glib(ffi::he_overlay_button_get_alignment(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_clicked<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn clicked_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, f: glib::ffi::gpointer) {
    ...
    fn connect_secondary_clicked<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn secondary_clicked_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"secondary-clicked\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(secondary_clicked_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "size")]
    fn connect_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_size_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::size\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_size_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "typeb")]
    fn connect_typeb_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_typeb_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::typeb\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_typeb_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "typeb2")]
    fn connect_typeb2_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_typeb2_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::typeb2\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_typeb2_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "color")]
    fn connect_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_color_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_secondary_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_secondary_color_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::secondary-color\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_secondary_color_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "secondary-icon")]
    fn connect_secondary_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_secondary_icon_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::secondary-icon\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_secondary_icon_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "icon")]
    fn connect_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_label_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_primary_tooltip_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_primary_tooltip_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::primary-tooltip\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_primary_tooltip_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "secondary-tooltip")]
    fn connect_secondary_tooltip_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_secondary_tooltip_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::secondary-tooltip\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_secondary_tooltip_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "alignment")]
    fn connect_alignment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_alignment_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::alignment\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_alignment_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
