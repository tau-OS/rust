...
glib::wrapper! {
    #[doc(alias = "HeOutlineButton")]
    pub struct OutlineButton(Object<ffi::HeOutlineButton, ffi::HeOutlineButtonClass>) @extends Button, gtk::Button, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;

    match fn {
        type_ => || ffi::he_outline_button_get_type(),
    }
}

impl OutlineButton {
        pub const NONE: Option<&'static OutlineButton> = None;
    

    #[doc(alias = "he_outline_button_new")]
    pub fn new(label: &str) -> OutlineButton {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_outline_button_new(label.to_glib_none().0))
        }
    }

            // rustdoc-stripper-ignore-next
            /// Creates a new builder-pattern struct instance to construct [`OutlineButton`] objects.
            ///
            /// This method returns an instance of [`OutlineButtonBuilder`](crate::builders::OutlineButtonBuilder) which can be used to create [`OutlineButton`] objects.
            pub fn builder() -> OutlineButtonBuilder {
                OutlineButtonBuilder::new()
            }
...
// rustdoc-stripper-ignore-next
        /// A [builder-pattern] type to construct [`OutlineButton`] objects.
        ///
        /// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct OutlineButtonBuilder {
            builder: glib::object::ObjectBuilder<'static, OutlineButton>,
        }

        impl OutlineButtonBuilder {
        fn new() -> Self {
    ...
    // rustdoc-stripper-ignore-next
    /// Build the [`OutlineButton`].
    #[must_use = "Building the object from the builder is usually expensive and is not expected to have side effects"]
    pub fn build(self) -> OutlineButton {
    self.builder.build() }
}
