...
impl Tip {
    ...
    pub fn new(title: &str, image: Option<&str>, message: Option<&str>, action_label: Option<&str>) -> Tip {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_full(ffi::he_tip_new(title.to_glib_none().0, image.to_glib_none().0, message.to_glib_none().0, action_label.to_glib_none().0))
        }
    }
...
pub struct TipBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("action-label", action_label.into()), }
                        }
...
pub trait TipExt: IsA<Tip> + sealed::Sealed + 'static {
    ...
    fn title(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_tip_get_title(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn image(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_tip_get_image(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn message(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_tip_get_message(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn action_label(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_tip_get_action_label(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<Tip>, F: Fn(&P) + 'static>(this: *mut ffi::HeTip, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_image_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_image_trampoline<P: IsA<Tip>, F: Fn(&P) + 'static>(this: *mut ffi::HeTip, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Tip::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_message_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_message_trampoline<P: IsA<Tip>, F: Fn(&P) + 'static>(this: *mut ffi::HeTip, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Tip::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::message\0".as_ptr() as *const _,
    ...
    fn connect_action_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_action_label_trampoline<P: IsA<Tip>, F: Fn(&P) + 'static>(this: *mut ffi::HeTip, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Tip::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::action-label\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_action_label_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
