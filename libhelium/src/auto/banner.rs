...
glib::wrapper! {
    #[doc(alias = "HeBanner")]
    pub struct Banner(Object<ffi::HeBanner, ffi::HeBannerClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
