...
impl Banner {
    ...
    pub fn new(title: &str, description: &str) -> Banner {
        ...
        unsafe {
            from_glib_none(ffi::he_banner_new(title.to_glib_none().0, description.to_glib_none().0))
        }
    }
...
pub struct BannerBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            pub fn style(self, style: BannerStyle) -> Self {
                            Self { builder: self.builder.property("style", style), }
                        }
...
pub trait BannerExt: IsA<Banner> + sealed::Sealed + 'static {
    ...
    fn add_action_button(&self, widget: &impl IsA<gtk::Widget>) {
        unsafe {
            ffi::he_banner_add_action_button(self.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0);
        }
    }
    ...
    fn remove_action(&self, widget: &impl IsA<gtk::Widget>) {
        unsafe {
            ffi::he_banner_remove_action(self.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0);
        }
    }
    ...
    fn title(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_banner_get_title(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn description(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_banner_get_description(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn style(&self) -> BannerStyle {
        unsafe {
            from_glib(ffi::he_banner_get_style(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<Banner>, F: Fn(&P) + 'static>(this: *mut ffi::HeBanner, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_description_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_description_trampoline<P: IsA<Banner>, F: Fn(&P) + 'static>(this: *mut ffi::HeBanner, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Banner::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_style_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_style_trampoline<P: IsA<Banner>, F: Fn(&P) + 'static>(this: *mut ffi::HeBanner, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Banner::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::style\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_style_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
