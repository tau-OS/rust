...
glib::wrapper! {
    ...
    pub struct ViewDual(Object<ffi::HeViewDual, ffi::HeViewDualClass>) @extends View, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
if let Some(ref width_request) = self.width_request {
        ...
        glib::Object::new::<ViewDual>(&properties)
