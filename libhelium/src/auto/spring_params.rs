...
impl SpringParams {
    ...
    pub fn new(damping_ratio: f64, mass: f64, stiffness: f64) -> SpringParams {
        ...
        unsafe {
            from_glib_full(ffi::he_spring_params_new(damping_ratio, mass, stiffness))
        }
    }
    ...
    pub fn full(damping: f64, mass: f64, stiffness: f64) -> SpringParams {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_full(ffi::he_spring_params_new_full(damping, mass, stiffness))
        }
    }
...
pub struct SpringParamsBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("damping", damping), }
                        }

                            pub fn damping_ratio(self, damping_ratio: f64) -> Self {
                            Self { builder: self.builder.property("damping-ratio", damping_ratio), }
                        }

                            pub fn mass(self, mass: f64) -> Self {
                            Self { builder: self.builder.property("mass", mass), }
                        }

                            pub fn stiffness(self, stiffness: f64) -> Self {
                            Self { builder: self.builder.property("stiffness", stiffness), }
                        }
...
pub trait SpringParamsExt: IsA<SpringParams> + sealed::Sealed + 'static {
    ...
    fn damping(&self) -> f64 {
        unsafe {
            ffi::he_spring_params_get_damping(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn damping_ratio(&self) -> f64 {
        unsafe {
            ffi::he_spring_params_get_damping_ratio(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn mass(&self) -> f64 {
        unsafe {
            ffi::he_spring_params_get_mass(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn stiffness(&self) -> f64 {
        unsafe {
            ffi::he_spring_params_get_stiffness(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn connect_damping_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_damping_trampoline<P: IsA<SpringParams>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringParams, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpringParams::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::damping\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_damping_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "damping-ratio")]
    fn connect_damping_ratio_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_damping_ratio_trampoline<P: IsA<SpringParams>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringParams, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpringParams::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::damping-ratio\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_damping_ratio_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "mass")]
    fn connect_mass_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_mass_trampoline<P: IsA<SpringParams>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringParams, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpringParams::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::mass\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_mass_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "stiffness")]
    fn connect_stiffness_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stiffness_trampoline<P: IsA<SpringParams>, F: Fn(&P) + 'static>(this: *mut ffi::HeSpringParams, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpringParams::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::stiffness\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_stiffness_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
