...
impl ViewChooser {
    ...
    pub fn new() -> ViewChooser {
        ...
        unsafe {
            from_glib_none(ffi::he_view_chooser_new())
        }
    }
...
pub trait ViewChooserExt: IsA<ViewChooser> + sealed::Sealed + 'static {
    ...
    fn stack(&self) -> gtk::Stack {
        unsafe {
            from_glib_none(ffi::he_view_chooser_get_stack(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_stack_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stack_trampoline<P: IsA<ViewChooser>, F: Fn(&P) + 'static>(this: *mut ffi::HeViewChooser, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
