...
glib::wrapper! {
    ...
    pub struct ViewSubTitle(Object<ffi::HeViewSubTitle, ffi::HeViewSubTitleClass>) @extends Bin, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
pub struct ViewSubTitleBuilder {
            builder: glib::object::ObjectBuilder<'static, ViewSubTitle>,
        }
