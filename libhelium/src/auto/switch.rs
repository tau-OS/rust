...
impl Switch {
    ...
    pub fn new() -> Switch {
        ...
        unsafe {
            from_glib_none(ffi::he_switch_new())
        }
    }
...
pub trait SwitchExt: IsA<Switch> + sealed::Sealed + 'static {
    ...
    fn left_icon(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_switch_get_left_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn right_icon(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_switch_get_right_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_left_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_left_icon_trampoline<P: IsA<Switch>, F: Fn(&P) + 'static>(this: *mut ffi::HeSwitch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_right_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_right_icon_trampoline<P: IsA<Switch>, F: Fn(&P) + 'static>(this: *mut ffi::HeSwitch, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Switch::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
