...
glib::wrapper! {
    ...
    pub struct EmptyPage(Object<ffi::HeEmptyPage, ffi::HeEmptyPageClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
if let Some(ref width_request) = self.width_request {
        ...
        glib::Object::new::<EmptyPage>(&properties)
    ...
    pub fn button(mut self, button: &str) -> Self {
        self.button = Some(button.to_string());
        self
    }
