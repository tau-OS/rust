...
glib::wrapper! {
    ...
    pub struct EmptyPage(Object<ffi::HeEmptyPage, ffi::HeEmptyPageClass>) @extends Bin, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::he_empty_page_get_type(),
    }
}

impl EmptyPage {
        pub const NONE: Option<&'static EmptyPage> = None;
    

    #[doc(alias = "he_empty_page_new")]
    pub fn new() -> EmptyPage {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_empty_page_new())
        }
    }

            // rustdoc-stripper-ignore-next
            /// Creates a new builder-pattern struct instance to construct [`EmptyPage`] objects.
            ///
            /// This method returns an instance of [`EmptyPageBuilder`](crate::builders::EmptyPageBuilder) which can be used to create [`EmptyPage`] objects.
            pub fn builder() -> EmptyPageBuilder {
                EmptyPageBuilder::new()
            }
...
// rustdoc-stripper-ignore-next
        /// A [builder-pattern] type to construct [`EmptyPage`] objects.
        ///
        /// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct EmptyPageBuilder {
            builder: glib::object::ObjectBuilder<'static, EmptyPage>,
        }

        impl EmptyPageBuilder {
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("button", button.into()), }
                        }
...
pub trait EmptyPageExt: IsA<EmptyPage> + sealed::Sealed + 'static {
    ...
    fn title(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_empty_page_get_title(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn description(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_empty_page_get_description(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_description(&self, value: &str) {
        unsafe {
            ffi::he_empty_page_set_description(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn icon(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_empty_page_get_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn button(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_empty_page_get_button(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<EmptyPage>, F: Fn(&P) + 'static>(this: *mut ffi::HeEmptyPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_description_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_description_trampoline<P: IsA<EmptyPage>, F: Fn(&P) + 'static>(this: *mut ffi::HeEmptyPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EmptyPage::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_trampoline<P: IsA<EmptyPage>, F: Fn(&P) + 'static>(this: *mut ffi::HeEmptyPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EmptyPage::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_resource_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_resource_trampoline<P: IsA<EmptyPage>, F: Fn(&P) + 'static>(this: *mut ffi::HeEmptyPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EmptyPage::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::resource\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_resource_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "button")]
    fn connect_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_button_trampoline<P: IsA<EmptyPage>, F: Fn(&P) + 'static>(this: *mut ffi::HeEmptyPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EmptyPage::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
