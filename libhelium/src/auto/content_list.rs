...
impl ContentList {
    ...
    pub fn new() -> ContentList {
        ...
        unsafe { from_glib_none(ffi::he_content_list_new()) }
    }
...
pub struct ContentListBuilder {
    builder: glib::object::ObjectBuilder<'static, ContentList>,
}
...
pub trait ContentListExt: IsA<ContentList> + 'static {
