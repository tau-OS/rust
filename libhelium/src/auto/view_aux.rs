...
glib::wrapper! {
    #[doc(alias = "HeViewAux")]
    pub struct ViewAux(Object<ffi::HeViewAux, ffi::HeViewAuxClass>) @extends View, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
pub struct ViewAuxBuilder {
            builder: glib::object::ObjectBuilder<'static, ViewAux>,
        }
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            pub fn show_aux(self, show_aux: bool) -> Self {
                            Self { builder: self.builder.property("show-aux", show_aux), }
                        }
    ...
    fn connect_show_aux_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-aux\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_show_aux_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
