...
impl ProgressBar {
    ...
    pub fn new() -> ProgressBar {
        ...
        unsafe {
            from_glib_none(ffi::he_progress_bar_new())
        }
    }
...
pub struct ProgressBarBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("is-osd", is_osd), }
                        }
...
pub trait ProgressBarExt: IsA<ProgressBar> + sealed::Sealed + 'static {
    ...
    fn is_stop_indicator_visibility(&self) -> bool {
        unsafe {
            from_glib(ffi::he_progress_bar_get_stop_indicator_visibility(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_stop_indicator_visibility(&self, value: bool) {
        unsafe {
            ffi::he_progress_bar_set_stop_indicator_visibility(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }
    ...
    fn is_osd(&self) -> bool {
        unsafe {
            from_glib(ffi::he_progress_bar_get_is_osd(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_stop_indicator_visibility_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stop_indicator_visibility_trampoline<P: IsA<ProgressBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeProgressBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_is_osd_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_osd_trampoline<P: IsA<ProgressBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeProgressBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ProgressBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::is-osd\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_is_osd_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
