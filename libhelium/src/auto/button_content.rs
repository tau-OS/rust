...
glib::wrapper! {
    ...
    pub struct ButtonContent(Object<ffi::HeButtonContent, ffi::HeButtonContentClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
