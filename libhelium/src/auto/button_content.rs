...
glib::wrapper! {
    ...
    pub struct ButtonContent(Object<ffi::HeButtonContent, ffi::HeButtonContentClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::he_button_content_get_type(),
    }
}

impl ButtonContent {
        pub const NONE: Option<&'static ButtonContent> = None;
    

    #[doc(alias = "he_button_content_new")]
    pub fn new() -> ButtonContent {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_button_content_new())
        }
    }
...
impl<O: IsA<ButtonContent>> ButtonContentExt for O {
    fn icon(&self) -> glib::GString {
        unsafe {
            from_glib_full(ffi::he_button_content_get_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn label(&self) -> glib::GString {
        unsafe {
            from_glib_full(ffi::he_button_content_get_label(self.as_ref().to_glib_none().0))
        }
    }

    fn set_label(&self, value: &str) {
        unsafe {
            ffi::he_button_content_set_label(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    fn connect_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_trampoline<P: IsA<ButtonContent>, F: Fn(&P) + 'static>(this: *mut ffi::HeButtonContent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ButtonContent::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_label_trampoline<P: IsA<ButtonContent>, F: Fn(&P) + 'static>(this: *mut ffi::HeButtonContent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ButtonContent::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
