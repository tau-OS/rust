...
impl SwitchBar {
    ...
    pub fn new() -> SwitchBar {
        ...
        unsafe {
            from_glib_none(ffi::he_switch_bar_new())
        }
    }
...
pub struct SwitchBarBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("sensitive-widget", sensitive_widget.clone().upcast()), }
                        }
...
pub trait SwitchBarExt: IsA<SwitchBar> + sealed::Sealed + 'static {
    ...
    fn title(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_switch_bar_get_title(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn subtitle(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_switch_bar_get_subtitle(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn sensitive_widget(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::he_switch_bar_get_sensitive_widget(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_sensitive_widget(&self, value: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::he_switch_bar_set_sensitive_widget(self.as_ref().to_glib_none().0, value.map(|p| p.as_ref()).to_glib_none().0);
        }
    }

    #[doc(alias = "activated")]
    fn connect_activated<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn activated_trampoline<P: IsA<SwitchBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSwitchBar, f: glib::ffi::gpointer) {
    ...
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<SwitchBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSwitchBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SwitchBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_subtitle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_subtitle_trampoline<P: IsA<SwitchBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSwitchBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SwitchBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_sensitive_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_sensitive_widget_trampoline<P: IsA<SwitchBar>, F: Fn(&P) + 'static>(this: *mut ffi::HeSwitchBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SwitchBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::sensitive-widget\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_sensitive_widget_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
