...
use crate::{ffi,Button,Colors};
use glib::{prelude::*,translate::*};

glib::wrapper! {
    #[doc(alias = "HeDisclosureButton")]
    pub struct DisclosureButton(Object<ffi::HeDisclosureButton, ffi::HeDisclosureButtonClass>) @extends Button, gtk::Button, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;

    match fn {
        type_ => || ffi::he_disclosure_button_get_type(),
    }
}

impl DisclosureButton {
        pub const NONE: Option<&'static DisclosureButton> = None;
    

    #[doc(alias = "he_disclosure_button_new")]
    pub fn new(icon: &str) -> DisclosureButton {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_disclosure_button_new(icon.to_glib_none().0))
        }
    }
    ...
    pub fn from_icon(icon: &str) -> DisclosureButton {
        ...
        unsafe {
            ...
            ///
            /// This method returns an instance of [`DisclosureButtonBuilder`](crate::builders::DisclosureButtonBuilder) which can be used to create [`DisclosureButton`] objects.
            pub fn builder() -> DisclosureButtonBuilder {
                DisclosureButtonBuilder::new()
            }
...
// rustdoc-stripper-ignore-next
        /// A [builder-pattern] type to construct [`DisclosureButton`] objects.
        ///
        /// [builder-pattern]: https://doc.rust-lang.org/1.0.0/style/ownership/builders.html
#[must_use = "The builder must be built to be used"]
pub struct DisclosureButtonBuilder {
            builder: glib::object::ObjectBuilder<'static, DisclosureButton>,
        }

        impl DisclosureButtonBuilder {
        fn new() -> Self {
    ...
    // rustdoc-stripper-ignore-next
    /// Build the [`DisclosureButton`].
    #[must_use = "Building the object from the builder is usually expensive and is not expected to have side effects"]
    pub fn build(self) -> DisclosureButton {
    self.builder.build() }
}
...
pub trait DisclosureButtonExt: IsA<DisclosureButton> + sealed::Sealed + 'static {
    ...
    fn icon(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::he_disclosure_button_get_icon(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_icon(&self, value: &str) {
        unsafe {
            ffi::he_disclosure_button_set_icon(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }
}
