...
glib::wrapper! {
    ...
    pub struct DisclosureButton(Object<ffi::HeDisclosureButton, ffi::HeDisclosureButtonClass>) @extends Button, gtk::Button, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
    ...
    pub fn from_icon(icon: &str) -> DisclosureButton {
        ...
        unsafe {
            ...
            pub fn builder() -> DisclosureButtonBuilder {
                DisclosureButtonBuilder::default()
            }
...
impl DisclosureButtonBuilder {
    // rustdoc-stripper-ignore-next
    /// Create a new [`DisclosureButtonBuilder`].
    pub fn new() -> Self {
        Self::default()
    }
...
if let Some(ref action_name) = self.action_name {
        ...
        glib::Object::new::<DisclosureButton>(&properties)
