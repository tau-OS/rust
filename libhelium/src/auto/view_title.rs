...
glib::wrapper! {
    ...
    pub struct ViewTitle(Object<ffi::HeViewTitle, ffi::HeViewTitleClass>) @extends Bin, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
pub struct ViewTitleBuilder {
            builder: glib::object::ObjectBuilder<'static, ViewTitle>,
        }
