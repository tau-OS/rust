...
impl BottomSheet {
    ...
    pub fn new() -> BottomSheet {
        ...
        unsafe {
            from_glib_none(ffi::he_bottom_sheet_new())
        }
    }
...
pub struct BottomSheetBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("sheet", sheet.clone().upcast()), }
                        }

                            pub fn button(self, button: &impl IsA<gtk::Widget>) -> Self {
                            Self { builder: self.builder.property("button", button.clone().upcast()), }
                        }
                            ...
                            Self { builder: self.builder.property("show-sheet", show_sheet), }
                        }
                            ...
                            Self { builder: self.builder.property("preferred-sheet-height", preferred_sheet_height), }
                        }
...
pub trait BottomSheetExt: IsA<BottomSheet> + sealed::Sealed + 'static {
    ...
    fn sheet(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::he_bottom_sheet_get_sheet(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_sheet(&self, value: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::he_bottom_sheet_set_sheet(self.as_ref().to_glib_none().0, value.map(|p| p.as_ref()).to_glib_none().0);
        }
    }
    ...
    fn button(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(ffi::he_bottom_sheet_get_button(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_button(&self, value: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::he_bottom_sheet_set_button(self.as_ref().to_glib_none().0, value.map(|p| p.as_ref()).to_glib_none().0);
        }
    }
    ...
    fn title(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::he_bottom_sheet_get_title(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn shows_sheet(&self) -> bool {
        unsafe {
            from_glib(ffi::he_bottom_sheet_get_show_sheet(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn is_modal(&self) -> bool {
        unsafe {
            from_glib(ffi::he_bottom_sheet_get_modal(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn shows_handle(&self) -> bool {
        unsafe {
            from_glib(ffi::he_bottom_sheet_get_show_handle(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn preferred_sheet_height(&self) -> i32 {
        unsafe {
            ffi::he_bottom_sheet_get_preferred_sheet_height(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn connect_hidden<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn hidden_trampoline<P: IsA<BottomSheet>, F: Fn(&P) + 'static>(this: *mut ffi::HeBottomSheet, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(BottomSheet::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"hidden\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(hidden_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "sheet")]
    fn connect_sheet_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_sheet_trampoline<P: IsA<BottomSheet>, F: Fn(&P) + 'static>(this: *mut ffi::HeBottomSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(BottomSheet::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::sheet\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_sheet_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "button")]
    fn connect_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_button_trampoline<P: IsA<BottomSheet>, F: Fn(&P) + 'static>(this: *mut ffi::HeBottomSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(BottomSheet::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::button\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_button_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "title")]
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<BottomSheet>, F: Fn(&P) + 'static>(this: *mut ffi::HeBottomSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(BottomSheet::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_show_sheet_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_sheet_trampoline<P: IsA<BottomSheet>, F: Fn(&P) + 'static>(this: *mut ffi::HeBottomSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(BottomSheet::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::show-sheet\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_show_sheet_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "modal")]
    fn connect_modal_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_modal_trampoline<P: IsA<BottomSheet>, F: Fn(&P) + 'static>(this: *mut ffi::HeBottomSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(BottomSheet::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::modal\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_modal_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-handle")]
    fn connect_show_handle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_handle_trampoline<P: IsA<BottomSheet>, F: Fn(&P) + 'static>(this: *mut ffi::HeBottomSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(BottomSheet::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_preferred_sheet_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_preferred_sheet_height_trampoline<P: IsA<BottomSheet>, F: Fn(&P) + 'static>(this: *mut ffi::HeBottomSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(BottomSheet::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::preferred-sheet-height\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_preferred_sheet_height_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
