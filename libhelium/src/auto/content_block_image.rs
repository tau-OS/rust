...
pub struct ContentBlockImageBuilder {
            builder: glib::object::ObjectBuilder<'static, ContentBlockImage>,
        }
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            pub fn requested_height(self, requested_height: i32) -> Self {
                            Self { builder: self.builder.property("requested-height", requested_height), }
                        }

                            pub fn requested_width(self, requested_width: i32) -> Self {
                            Self { builder: self.builder.property("requested-width", requested_width), }
                        }
    ...
    fn connect_file_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::file\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_file_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_requested_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::requested-height\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_requested_height_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_requested_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::requested-width\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_requested_width_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
