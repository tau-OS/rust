...
glib::wrapper! {
    #[doc(alias = "HeViewSwitcher")]
    pub struct ViewSwitcher(Object<ffi::HeViewSwitcher, ffi::HeViewSwitcherClass>) @extends Bin, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::he_view_switcher_get_type(),
    }
}

impl ViewSwitcher {
        pub const NONE: Option<&'static ViewSwitcher> = None;
    

    #[doc(alias = "he_view_switcher_new")]
    pub fn new() -> ViewSwitcher {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ffi::he_view_switcher_new())
        }
    }
...
mod sealed {
    pub trait Sealed {}
    impl<T: super::IsA<super::ViewSwitcher>> Sealed for T {}
}

pub trait ViewSwitcherExt: IsA<ViewSwitcher> + sealed::Sealed + 'static {
    #[doc(alias = "he_view_switcher_get_stack")]
    #[doc(alias = "get_stack")]
    fn stack(&self) -> gtk::Stack {
        unsafe {
            from_glib_none(ffi::he_view_switcher_get_stack(self.as_ref().to_glib_none().0))
        }
    }

    #[doc(alias = "he_view_switcher_set_stack")]
    fn set_stack(&self, value: &gtk::Stack) {
        unsafe {
            ffi::he_view_switcher_set_stack(self.as_ref().to_glib_none().0, value.to_glib_none().0);
        }
    }

    #[doc(alias = "stack")]
    fn connect_stack_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stack_trampoline<P: IsA<ViewSwitcher>, F: Fn(&P) + 'static>(this: *mut ffi::HeViewSwitcher, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
