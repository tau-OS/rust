...
glib::wrapper! {
    ...
    pub struct ViewSwitcher(Object<ffi::HeViewSwitcher, ffi::HeViewSwitcherClass>) @extends Bin, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
