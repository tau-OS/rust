...
glib::wrapper! {
    ...
    pub struct ApplicationWindow(Object<ffi::HeApplicationWindow, ffi::HeApplicationWindowClass>) @extends gtk::Window, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Native, gtk::Root, gtk::ShortcutManager, gio::ActionGroup, gio::ActionMap;
...
impl ApplicationWindow {
    ...
    pub fn new(app: &impl IsA<Application>) -> ApplicationWindow {
        ...
        unsafe {
            from_glib_none(ffi::he_application_window_new(app.as_ref().to_glib_none().0))
        }
    }
...
impl<O: IsA<ApplicationWindow>> ApplicationWindowExt for O {
    fn is_modal(&self) -> bool {
        unsafe {
            from_glib(ffi::he_application_window_get_modal(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn has_title(&self) -> bool {
        unsafe {
            from_glib(ffi::he_application_window_get_has_title(self.as_ref().to_glib_none().0))
        }
    }

    fn set_has_title(&self, value: bool) {
        unsafe {
            ffi::he_application_window_set_has_title(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }

    fn has_back_button(&self) -> bool {
        unsafe {
            from_glib(ffi::he_application_window_get_has_back_button(self.as_ref().to_glib_none().0))
        }
    }

    fn set_has_back_button(&self, value: bool) {
        unsafe {
            ffi::he_application_window_set_has_back_button(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }

    fn connect_has_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_has_title_trampoline<P: IsA<ApplicationWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeApplicationWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ApplicationWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::has-title\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_has_title_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_has_back_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_has_back_button_trampoline<P: IsA<ApplicationWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeApplicationWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ApplicationWindow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::has-back-button\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_has_back_button_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
