...
pub type HeDarkModeStrength = c_int;
pub const HE_DARK_MODE_STRENGTH_MEDIUM: HeDarkModeStrength = 0;
pub const HE_DARK_MODE_STRENGTH_HARSH: HeDarkModeStrength = 1;
pub const HE_DARK_MODE_STRENGTH_SOFT: HeDarkModeStrength = 2;
...
pub type HeContentSchemePrivate = *mut _HeContentSchemePrivate;
...
pub type HeDefaultSchemePrivate = *mut _HeDefaultSchemePrivate;
...
pub type HeMonochromaticSchemePrivate = *mut _HeMonochromaticSchemePrivate;
...
pub type HeMutedSchemePrivate = *mut _HeMutedSchemePrivate;
...
#[repr(C)]
pub struct HeScheme {
    pub neutral_background_hex: *mut c_char,
    pub neutral_background_variant_hex: *mut c_char,
    pub neutral_foreground_hex: *mut c_char,
    pub neutral_foreground_variant_hex: *mut c_char,
    pub inverse_neutral_background_hex: *mut c_char,
    pub inverse_neutral_foreground_hex: *mut c_char,
...
impl ::std::fmt::Debug for HeScheme {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeScheme @ {self:p}"))
            .field("neutral_background_hex", &self.neutral_background_hex)
            .field(
                "neutral_background_variant_hex",
                &self.neutral_background_variant_hex,
            )
            .field("neutral_foreground_hex", &self.neutral_foreground_hex)
            .field(
                "neutral_foreground_variant_hex",
                &self.neutral_foreground_variant_hex,
            )
            .field(
                "inverse_neutral_background_hex",
                &self.inverse_neutral_background_hex,
            )
            .field(
                "inverse_neutral_foreground_hex",
                &self.inverse_neutral_foreground_hex,
            )
...
pub struct HeSchemeFactoryIface {
    ...
    pub generate: Option<
        unsafe extern "C" fn(*mut HeSchemeFactory, *mut HeColorCAM16Color, gboolean, *mut HeScheme),
    >,
}
...
pub type HeStyleManagerPrivate = *mut _HeStyleManagerPrivate;
...
pub type HeVibrantSchemePrivate = *mut _HeVibrantSchemePrivate;
...
pub struct HeStyleManager {
    ...
    pub dark_mode_strength: HeDarkModeStrength,
}
...
impl ::std::fmt::Debug for HeStyleManager {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeStyleManager @ {self:p}"))
            ...
            .field("dark_mode_strength", &self.dark_mode_strength)
            .finish()
    }
}
...
extern "C" {
    ...
    // HeDarkModeStrength
    //=========================================================================
    pub fn he_dark_mode_strength_get_type() -> GType;
    ...
    pub fn he_desktop_get_dark_mode_strength(self_: *mut HeDesktop) -> HeDarkModeStrength;
