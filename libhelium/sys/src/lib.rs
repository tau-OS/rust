...
pub type HeChipGroupPrivate = *mut _HeChipGroupPrivate;
...
pub type HeDatePickerPrivate = *mut _HeDatePickerPrivate;
...
pub type HeQuantizerCelebiPrivate = *mut _HeQuantizerCelebiPrivate;
...
pub type HeQuantizerMapPrivate = *mut _HeQuantizerMapPrivate;
...
pub type HeQuantizerPrivate = *mut _HeQuantizerPrivate;
...
pub type HeQuantizerResultPrivate = *mut _HeQuantizerResultPrivate;
...
pub type HeQuantizerWsmeansPrivate = *mut _HeQuantizerWsmeansPrivate;
...
pub type HeQuantizerWuPrivate = *mut _HeQuantizerWuPrivate;
...
pub type HeSchemePrivate = *mut _HeSchemePrivate;

#[derive(Copy, Clone)]
#[repr(C)]
pub struct HeSchemesContentClass {
    pub parent_class: HeSchemeClass,
}

impl ::std::fmt::Debug for HeSchemesContentClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeSchemesContentClass @ {self:p}"))
            .finish()
    }
}

#[repr(C)]
pub struct _HeSchemesContentPrivate {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type HeSchemesContentPrivate = *mut _HeSchemesContentPrivate;

#[derive(Copy, Clone)]
#[repr(C)]
pub struct HeSchemesDefaultClass {
    pub parent_class: HeSchemeClass,
}

impl ::std::fmt::Debug for HeSchemesDefaultClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeSchemesDefaultClass @ {self:p}"))
            .finish()
    }
}

#[repr(C)]
pub struct _HeSchemesDefaultPrivate {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type HeSchemesDefaultPrivate = *mut _HeSchemesDefaultPrivate;

#[derive(Copy, Clone)]
#[repr(C)]
pub struct HeSchemesMonochromeClass {
    pub parent_class: HeSchemeClass,
}

impl ::std::fmt::Debug for HeSchemesMonochromeClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeSchemesMonochromeClass @ {self:p}"))
            .finish()
    }
}

#[repr(C)]
pub struct _HeSchemesMonochromePrivate {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type HeSchemesMonochromePrivate = *mut _HeSchemesMonochromePrivate;

#[derive(Copy, Clone)]
#[repr(C)]
pub struct HeSchemesMutedClass {
    pub parent_class: HeSchemeClass,
}

impl ::std::fmt::Debug for HeSchemesMutedClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeSchemesMutedClass @ {self:p}"))
            .finish()
    }
}

#[repr(C)]
pub struct _HeSchemesMutedPrivate {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type HeSchemesMutedPrivate = *mut _HeSchemesMutedPrivate;

#[derive(Copy, Clone)]
#[repr(C)]
pub struct HeSchemesVibrantClass {
    pub parent_class: HeSchemeClass,
}

impl ::std::fmt::Debug for HeSchemesVibrantClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeSchemesVibrantClass @ {self:p}"))
            .finish()
    }
}

#[repr(C)]
pub struct _HeSchemesVibrantPrivate {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type HeSchemesVibrantPrivate = *mut _HeSchemesVibrantPrivate;
...
pub type HeScoreAnnotatedColorPrivate = *mut _HeScoreAnnotatedColorPrivate;
...
pub type HeScorePrivate = *mut _HeScorePrivate;
...
pub type HeSwitchBarPrivate = *mut _HeSwitchBarPrivate;
...
pub type HeTextFieldPrivate = *mut _HeTextFieldPrivate;
...
pub type HeTimePickerPrivate = *mut _HeTimePickerPrivate;
...
pub type HeViewingConditionsPrivate = *mut _HeViewingConditionsPrivate;
...
pub struct HeScheme {
    ...
    pub he_scheme_hue: c_double,
    pub he_scheme_chroma: c_double,
}

impl ::std::fmt::Debug for HeScheme {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeScheme @ {self:p}"))
            .field("he_scheme_hue", &self.he_scheme_hue)
            .field("he_scheme_chroma", &self.he_scheme_chroma)
            .finish()
    }
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct HeSchemesContent {
    pub parent_instance: HeScheme,
    pub priv_: *mut HeSchemesContentPrivate,
}

impl ::std::fmt::Debug for HeSchemesContent {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeSchemesContent @ {self:p}"))
            .finish()
    }
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct HeSchemesDefault {
    pub parent_instance: HeScheme,
    pub priv_: *mut HeSchemesDefaultPrivate,
}

impl ::std::fmt::Debug for HeSchemesDefault {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeSchemesDefault @ {self:p}"))
            .finish()
    }
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct HeSchemesMonochrome {
    pub parent_instance: HeScheme,
    pub priv_: *mut HeSchemesMonochromePrivate,
}

impl ::std::fmt::Debug for HeSchemesMonochrome {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeSchemesMonochrome @ {self:p}"))
            .finish()
    }
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct HeSchemesMuted {
    pub parent_instance: HeScheme,
    pub priv_: *mut HeSchemesMutedPrivate,
}

impl ::std::fmt::Debug for HeSchemesMuted {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeSchemesMuted @ {self:p}"))
            .finish()
    }
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct HeSchemesVibrant {
    pub parent_instance: HeScheme,
    pub priv_: *mut HeSchemesVibrantPrivate,
}

impl ::std::fmt::Debug for HeSchemesVibrant {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("HeSchemesVibrant @ {self:p}"))
            .finish()
    }
}
...
extern "C" {
    ...
    pub fn he_application_get_default_font_weight(self_: *mut HeApplication) -> c_double;
    pub fn he_application_set_default_font_weight(self_: *mut HeApplication, value: c_double);
    ...
    pub fn he_scheme_new(cam16_color: HeColorCAM16Color, desktop: *mut HeDesktop) -> *mut HeScheme;
    pub fn he_scheme_get_neutral_background_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_neutral_background_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_neutral_background_variant_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_neutral_background_variant_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_neutral_foreground_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_neutral_foreground_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_neutral_foreground_variant_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_neutral_foreground_variant_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_inverse_neutral_background_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_inverse_neutral_background_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_inverse_neutral_foreground_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_inverse_neutral_foreground_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_primary_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_primary_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_on_primary_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_on_primary_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_primary_container_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_primary_container_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_on_primary_container_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_on_primary_container_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_inverse_primary_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_inverse_primary_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_error_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_error_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_on_error_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_on_error_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_secondary_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_secondary_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_on_secondary_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_on_secondary_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_secondary_container_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_secondary_container_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_on_secondary_container_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_on_secondary_container_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_tertiary_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_tertiary_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_on_tertiary_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_on_tertiary_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_tertiary_container_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_tertiary_container_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_on_tertiary_container_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_on_tertiary_container_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_outline_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_outline_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_outline_variant_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_outline_variant_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_shadow_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_shadow_hex(self_: *mut HeScheme, value: *const c_char);
    pub fn he_scheme_get_scrim_hex(self_: *mut HeScheme) -> *const c_char;
    pub fn he_scheme_set_scrim_hex(self_: *mut HeScheme, value: *const c_char);

    //=========================================================================
    // HeSchemesContent
    //=========================================================================
    pub fn he_schemes_content_get_type() -> GType;
    pub fn he_schemes_content_new(
        cam16_color: HeColorCAM16Color,
        desktop: *mut HeDesktop,
    ) -> *mut HeSchemesContent;

    //=========================================================================
    // HeSchemesDefault
    //=========================================================================
    pub fn he_schemes_default_get_type() -> GType;
    pub fn he_schemes_default_new(
        cam16_color: HeColorCAM16Color,
        desktop: *mut HeDesktop,
    ) -> *mut HeSchemesDefault;

    //=========================================================================
    // HeSchemesMonochrome
    //=========================================================================
    pub fn he_schemes_monochrome_get_type() -> GType;
    pub fn he_schemes_monochrome_new(
        cam16_color: HeColorCAM16Color,
        desktop: *mut HeDesktop,
    ) -> *mut HeSchemesMonochrome;

    //=========================================================================
    // HeSchemesMuted
    //=========================================================================
    pub fn he_schemes_muted_get_type() -> GType;
    pub fn he_schemes_muted_new(
        cam16_color: HeColorCAM16Color,
        desktop: *mut HeDesktop,
    ) -> *mut HeSchemesMuted;
    ...
    // HeSchemesVibrant
    //=========================================================================
    pub fn he_schemes_vibrant_get_type() -> GType;
    pub fn he_schemes_vibrant_new(
        cam16_color: HeColorCAM16Color,
        desktop: *mut HeDesktop,
    ) -> *mut HeSchemesVibrant;
    ...
    // Other functions
    //=========================================================================
    pub fn he_color_rgb_to_argb_int(color: HeColorRGBColor) -> c_int;
    pub fn he_color_lab_to_argb_int(lab: HeColorLABColor) -> c_int;
    pub fn he_color_argb_from_rgb_int(red: c_int, green: c_int, blue: c_int) -> c_int;
    pub fn he_color_xyz_to_argb(xyz: HeColorXYZColor) -> c_int;
    ...
    pub fn he_color_xyz_to_cam16(color: HeColorXYZColor, result: *mut HeColorCAM16Color);
    ...
    pub fn he_color_disliked(hct: HeColorHCTColor) -> gboolean;
    pub fn he_color_fix_disliked(hct: HeColorHCTColor, result: *mut HeColorHCTColor);
    ...
    pub fn he_color_hct_blend(a: HeColorHCTColor, b: HeColorHCTColor, result: *mut HeColorHCTColor);
    ...
    pub fn he_color_xyz_to_lab(color: HeColorXYZColor, result: *mut HeColorLABColor);
    ...
    pub fn he_color_lab_to_lch(color: HeColorLABColor, result: *mut HeColorLCHColor);
    pub fn he_color_hct_to_lch(color: HeColorHCTColor, result: *mut HeColorLCHColor);
    pub fn he_color_xyz_to_rgb(color: HeColorXYZColor, result: *mut HeColorRGBColor);
    pub fn he_color_lab_to_rgb(color: HeColorLABColor, result: *mut HeColorRGBColor);
    pub fn he_color_lch_to_rgb(color: HeColorLCHColor, result: *mut HeColorRGBColor);
    ...
    pub fn he_color_cam16_to_xyz(color: HeColorCAM16Color, result: *mut HeColorXYZColor);
