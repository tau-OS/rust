...
pub struct HeSchemeFactoryIface {
    ...
    pub generate: Option<unsafe extern "C" fn(*mut HeSchemeFactory, *mut HeColorCAM16Color, gboolean, c_double, *mut HeScheme)>,
}
...
extern "C" {
    ...
    pub fn he_contrast_curve_new(target: c_double, low: c_double, normal: c_double, medium: c_double, high: c_double) -> *mut HeContrastCurve;
    ...
    pub fn he_temperature_cache_get_complement(self_: *mut HeTemperatureCache, result: *mut HeColorHCTColor);
    pub fn he_temperature_cache_get_analogous_colors_simple(self_: *mut HeTemperatureCache, result_length1: *mut c_int) -> *mut HeColorHCTColor;
    pub fn he_temperature_cache_get_analogous_colors(self_: *mut HeTemperatureCache, count: c_int, divisions: c_int, result_length1: *mut c_int) -> *mut HeColorHCTColor;
    pub fn he_temperature_cache_get_relative_temp(self_: *mut HeTemperatureCache, color: *mut HeColorHCTColor) -> c_double;
    ...
    pub fn he_scheme_factory_generate(self_: *mut HeSchemeFactory, accent: *mut HeColorCAM16Color, is_dark: gboolean, contrast: c_double, result: *mut HeScheme);
