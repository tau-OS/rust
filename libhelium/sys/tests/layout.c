...
int main() {
    ...
    printf("%s;%zu;%zu\n", "HeColorCAM16Color", sizeof(HeColorCAM16Color), alignof(HeColorCAM16Color));
    printf("%s;%zu;%zu\n", "HeColorHCTColor", sizeof(HeColorHCTColor), alignof(HeColorHCTColor));
    ...
    printf("%s;%zu;%zu\n", "HeSchemesContent", sizeof(HeSchemesContent), alignof(HeSchemesContent));
    printf("%s;%zu;%zu\n", "HeSchemesContentClass", sizeof(HeSchemesContentClass), alignof(HeSchemesContentClass));
    printf("%s;%zu;%zu\n", "HeSchemesDefault", sizeof(HeSchemesDefault), alignof(HeSchemesDefault));
    printf("%s;%zu;%zu\n", "HeSchemesDefaultClass", sizeof(HeSchemesDefaultClass), alignof(HeSchemesDefaultClass));
    printf("%s;%zu;%zu\n", "HeSchemesMonochrome", sizeof(HeSchemesMonochrome), alignof(HeSchemesMonochrome));
    printf("%s;%zu;%zu\n", "HeSchemesMonochromeClass", sizeof(HeSchemesMonochromeClass), alignof(HeSchemesMonochromeClass));
    printf("%s;%zu;%zu\n", "HeSchemesMuted", sizeof(HeSchemesMuted), alignof(HeSchemesMuted));
    printf("%s;%zu;%zu\n", "HeSchemesMutedClass", sizeof(HeSchemesMutedClass), alignof(HeSchemesMutedClass));
    printf("%s;%zu;%zu\n", "HeSchemesVibrant", sizeof(HeSchemesVibrant), alignof(HeSchemesVibrant));
    printf("%s;%zu;%zu\n", "HeSchemesVibrantClass", sizeof(HeSchemesVibrantClass), alignof(HeSchemesVibrantClass));
