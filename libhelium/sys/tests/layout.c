...
int main() {
    ...
    printf("%s;%zu;%zu\n", "HeDesktopContrastScheme", sizeof(HeDesktopContrastScheme), alignof(HeDesktopContrastScheme));
    ...
    printf("%s;%zu;%zu\n", "HeSchemeFactoryIface", sizeof(HeSchemeFactoryIface), alignof(HeSchemeFactoryIface));
