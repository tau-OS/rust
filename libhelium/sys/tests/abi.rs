...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    (
        ...
        Layout {
            size: size_of::<HeDesktopContrastScheme>(),
            alignment: align_of::<HeDesktopContrastScheme>(),
        },
    ),
    (
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) HE_DESKTOP_CONTRAST_SCHEME_DEFAULT", "0"),
    ("(gint) HE_DESKTOP_CONTRAST_SCHEME_HIGH", "1"),
    ("(gint) HE_DESKTOP_CONTRAST_SCHEME_LOW", "2"),
