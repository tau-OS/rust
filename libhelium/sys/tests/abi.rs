...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    (
        "HeDarkModeStrength",
        Layout {
            size: size_of::<HeDarkModeStrength>(),
            alignment: align_of::<HeDarkModeStrength>(),
        },
    ),
    (
        "HeDatePicker",
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) HE_DARK_MODE_STRENGTH_HARSH", "1"),
    ("(gint) HE_DARK_MODE_STRENGTH_MEDIUM", "0"),
    ("(gint) HE_DARK_MODE_STRENGTH_SOFT", "2"),
