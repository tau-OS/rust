...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    ("HeContrastCurve", Layout {size: size_of::<HeContrastCurve>(), alignment: align_of::<HeContrastCurve>()}),
    ("HeContrastCurveClass", Layout {size: size_of::<HeContrastCurveClass>(), alignment: align_of::<HeContrastCurveClass>()}),
