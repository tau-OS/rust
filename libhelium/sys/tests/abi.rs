...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    (
        "HeSchemesContent",
        Layout {
            size: size_of::<HeSchemesContent>(),
            alignment: align_of::<HeSchemesContent>(),
        },
    ),
    (
        "HeSchemesContentClass",
        Layout {
            size: size_of::<HeSchemesContentClass>(),
            alignment: align_of::<HeSchemesContentClass>(),
        },
    ),
    (
        "HeSchemesDefault",
        Layout {
            size: size_of::<HeSchemesDefault>(),
            alignment: align_of::<HeSchemesDefault>(),
        },
    ),
    (
        "HeSchemesDefaultClass",
        Layout {
            size: size_of::<HeSchemesDefaultClass>(),
            alignment: align_of::<HeSchemesDefaultClass>(),
        },
    ),
    (
        "HeSchemesMonochrome",
        Layout {
            size: size_of::<HeSchemesMonochrome>(),
            alignment: align_of::<HeSchemesMonochrome>(),
        },
    ),
    (
        "HeSchemesMonochromeClass",
        Layout {
            size: size_of::<HeSchemesMonochromeClass>(),
            alignment: align_of::<HeSchemesMonochromeClass>(),
        },
    ),
    (
        "HeSchemesMuted",
        Layout {
            size: size_of::<HeSchemesMuted>(),
            alignment: align_of::<HeSchemesMuted>(),
        },
    ),
    (
        "HeSchemesMutedClass",
        Layout {
            size: size_of::<HeSchemesMutedClass>(),
            alignment: align_of::<HeSchemesMutedClass>(),
        },
    ),
    (
        "HeSchemesVibrant",
        Layout {
            size: size_of::<HeSchemesVibrant>(),
            alignment: align_of::<HeSchemesVibrant>(),
        },
    ),
    (
        "HeSchemesVibrantClass",
        Layout {
            size: size_of::<HeSchemesVibrantClass>(),
            alignment: align_of::<HeSchemesVibrantClass>(),
        },
    ),
    (
        "HeScore",
