...
int main() {
    ...
    PRINT_CONSTANT((gint) HE_DESKTOP_CONTRAST_SCHEME_DEFAULT);
    PRINT_CONSTANT((gint) HE_DESKTOP_CONTRAST_SCHEME_HIGH);
    PRINT_CONSTANT((gint) HE_DESKTOP_CONTRAST_SCHEME_LOW);
